...
# begin GNU MAKE file
# making order:
# 1. nmake /f xdb_postgre.mk test --if need to creating some directory or file-list
# 2. nmake /f xdb_postgre.mk clean
# 3. nmake /f xdb_postgre.mk
# 4. nmake /f xdb_postgre.mk install
#-----------------------------------------------------------------------------
CC = gcc
