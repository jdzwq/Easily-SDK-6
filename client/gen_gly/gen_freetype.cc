...
void gen_gly(FT_Face ft_face, glyph_info_t* pgi)
{
...
int main(int argc, const char * argv[]) {
	...
	gen_gly(ft_face, ascii_medium_regular_list);
	...
	FT_New_Face(ft_lib, fpath, 0, &ft_face);
	FT_Select_Charmap(ft_face, FT_ENCODING_UNICODE);
	gen_gly(ft_face, gb2312_medium_regular_list);
	FT_Done_Face(ft_face);

	/*get_runpath(NULL, fpath, 1024);
	xscat(fpath, _T("/ttf/arialb.ttf"));
	FT_New_Face(ft_lib, fpath, 0, &ft_face);
	gen_gly(ft_face, ascii_bold_regular_list);
	FT_Done_Face(ft_face);

	get_runpath(NULL, fpath, 1024);
	xscat(fpath, _T("/ttf/ariali.ttf"));
	FT_New_Face(ft_lib, fpath, 0, &ft_face);
	gen_gly(ft_face, ascii_medium_italic_list);
	FT_Done_Face(ft_face);

	get_runpath(NULL, fpath, 1024);
	xscat(fpath, _T("/ttf/arialbi.ttf"));
	FT_New_Face(ft_lib, fpath, 0, &ft_face);
	gen_gly(ft_face, ascii_bold_italic_list);
	FT_Done_Face(ft_face);

	get_runpath(NULL, fpath, 1024);
	xscat(fpath, _T("/ttf/arialb.ttf"));
	FT_New_Face(ft_lib, fpath, 0, &ft_face);
	gen_gly(ft_face, gb2312_bold_regular_list);
	FT_Done_Face(ft_face);

	get_runpath(NULL, fpath, 1024);
	xscat(fpath, _T("/ttf/ariali.ttf"));
	FT_New_Face(ft_lib, fpath, 0, &ft_face);
	gen_gly(ft_face, gb2312_medium_italic_list);
	FT_Done_Face(ft_face);

	get_runpath(NULL, fpath, 1024);
	xscat(fpath, _T("/ttf/arialbi.ttf"));
	FT_New_Face(ft_lib, fpath, 0, &ft_face);
	gen_gly(ft_face, gb2312_bold_italic_list);
	FT_Done_Face(ft_face);*/

	/*get_runpath(NULL, fpath, 1024);
	xscat(fpath, _T("/ttf/arial.ttf"));
	FT_New_Face(ft_lib, fpath, 0, &ft_face);
	gen_gly(ft_face, unicode_medium_regular_list);
	FT_Done_Face(ft_face);

	get_runpath(NULL, fpath, 1024);
	xscat(fpath, _T("/ttf/arialb.ttf"));
	FT_New_Face(ft_lib, fpath, 0, &ft_face);
	gen_gly(ft_face, unicode_bold_regular_list);
	FT_Done_Face(ft_face);

	get_runpath(NULL, fpath, 1024);
	xscat(fpath, _T("/ttf/ariali.ttf"));
	FT_New_Face(ft_lib, fpath, 0, &ft_face);
	gen_gly(ft_face, unicode_medium_italic_list);
	FT_Done_Face(ft_face);

	get_runpath(NULL, fpath, 1024);
	xscat(fpath, _T("/ttf/arialbi.ttf"));
	FT_New_Face(ft_lib, fpath, 0, &ft_face);
	gen_gly(ft_face, unicode_bold_italic_list);
	FT_Done_Face(ft_face);*/
