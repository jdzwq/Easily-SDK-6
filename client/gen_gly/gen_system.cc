...
void gen_gly(visual_t vc, glyph_info_t* pgi)
{
	visual_t vc_mem;
...
#else
			len = ucs_byte_to_mbs(wc, tc);
			(*if_context.pf_gdi_text_size)(vc_mem, &xf, tc, len, &xs);
#endif
...
#else
			(*if_context.pf_gdi_text_out)(vc_mem, &xf, &pt, tc, len);
#endif
...
int main(int argc, const char * argv[]) {
	...
	gen_gly(vc, ascii_medium_regular_list);
	(*if_context.pf_destroy_context)(vc);

	vc = (*if_context.pf_create_display_context)(NULL);
	gen_gly(vc, ascii_bold_regular_list);
	(*if_context.pf_destroy_context)(vc);

	vc = (*if_context.pf_create_display_context)(NULL);
	gen_gly(vc, ascii_medium_italic_list);
	(*if_context.pf_destroy_context)(vc);

	vc = (*if_context.pf_create_display_context)(NULL);
	gen_gly(vc, ascii_bold_italic_list);
	(*if_context.pf_destroy_context)(vc);

	vc = (*if_context.pf_create_display_context)(NULL);
	gen_gly(vc, gb2312_medium_regular_list);
	(*if_context.pf_destroy_context)(vc);

	vc = (*if_context.pf_create_display_context)(NULL);
	gen_gly(vc, gb2312_bold_regular_list);
	(*if_context.pf_destroy_context)(vc);

	vc = (*if_context.pf_create_display_context)(NULL);
	gen_gly(vc, gb2312_medium_italic_list);
	(*if_context.pf_destroy_context)(vc);

	vc = (*if_context.pf_create_display_context)(NULL);
	gen_gly(vc, gb2312_bold_italic_list);
	(*if_context.pf_destroy_context)(vc);

	/*vc = (*if_context.pf_create_display_context)(NULL);
	gen_gly(vc, unicode_medium_regular_list);
	(*if_context.pf_destroy_context)(vc);

	vc = (*if_context.pf_create_display_context)(NULL);
	gen_gly(vc, unicode_bold_regular_list);
	(*if_context.pf_destroy_context)(vc);

	vc = (*if_context.pf_create_display_context)(NULL);
	gen_gly(vc, unicode_medium_italic_list);
	(*if_context.pf_destroy_context)(vc);

	vc = (*if_context.pf_create_display_context)(NULL);
	gen_gly(vc, unicode_bold_italic_list);
	(*if_context.pf_destroy_context)(vc);*/
