...
#define SETDIALOGPANELDELTA(ph,ptd)		widget_set_user_delta(ph,(vword_t)ptd)

#define DIALOGPANEL_ACCEL_COUNT	5
accel_table_t	DIALOGPANEL_ACCEL[DIALOGPANEL_ACCEL_COUNT] = {
...
/***************************************************************************************/
void DialogPanel_SetDirty(widget_t widget, bool_t bDirty)
{
...
LINKPTR DialogPanel_GetDocument(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
bool_t DialogPanel_OpenFile(widget_t widget, const tchar_t* szFile)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
bool_t DialogPanel_SaveFile(widget_t widget, const tchar_t* szFile)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_SelectAttr(widget_t widget, const tchar_t* attr_name, const tchar_t* attr_val)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
/*********************************************************************************************************/
void DialogPanel_OnSave(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnSaveAs(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnPrint(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnPreview(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
static void demoDlg_OnSubbing(widget_t widget, uid_t sid, vword_t delta)
{
...
void DialogPanel_OnExec(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
	...
	widget_t dlg = create_dialog(ptr_dlg, widget);
...
void DialogPanel_OnSelectAll(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);

	LINKPTR ptrDialog = dialogctrl_fetch(pdt->hDialog);
	XDK_ASSERT(ptrDialog);
...
void DialogPanel_OnDelete(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnCopy(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnCut(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnPaste(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnRedo(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);

}

void DialogPanel_OnUndo(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnCSSProper(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnFontName(widget_t widget, void* pv)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnFontSize(widget_t widget, void* pv)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnTextColor(widget_t widget, void* pv)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnPaintColor(widget_t widget, void* pv)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnDrawColor(widget_t widget, void* pv)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnTextNear(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnTextBold(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnTextCenter(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnTextFar(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnAlignNear(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnAlignCenter(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnAlignFar(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnSizeHeight(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnSizeWidth(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnSizeHorz(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnSizeVert(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnSendBack(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnEditBox(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnListBox(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnNaviBox(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnSpinBox(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnSlideBox(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnRadioBox(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnCheckBox(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnDateBox(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnTimeBox(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnShapeBox(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnPushBox(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnUserBox(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnAttributes(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnStyleSheet(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_Proper_OnEntityUpdate(widget_t widget, NOTICE_PROPER* pnp)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_Title_OnItemChanging(widget_t widget, NOTICE_TITLE* pnt)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_Title_OnItemChanged(widget_t widget, NOTICE_TITLE* pnt)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
/***********************************************************************************************************/
int DialogPanel_OnCreate(widget_t widget, void* data)
{
	...
	widget_set_accel(widget, DIALOGPANEL_ACCEL, DIALOGPANEL_ACCEL_COUNT);
...
void DialogPanel_OnDestroy(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnShow(widget_t widget, bool_t bShow)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
int DialogPanel_OnClose(widget_t widget)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnCommandFind(widget_t widget, str_find_t* pfd)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnParentCommand(widget_t widget, int code, vword_t data)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnMenuCommand(widget_t widget, int code, int cid, vword_t data)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
...
void DialogPanel_OnNotice(widget_t widget, LPNOTICE phdr)
{
	DialogPanelDelta* pdt = GETDIALOGPANELDELTA(widget);
	...
	else if (phdr->user == IDC_DIALOGPANEL_PROPER)
	{
...
/**************************************************************************************************************/
widget_t DialogPanel_Create(const tchar_t* wname, dword_t wstyle, const xrect_t* pxr, const tchar_t* fpath)
{
	if_dispatch_t ev = { 0 };
