...
accel_table_t	GRIDPANEL_ACCEL[GRIDPANEL_ACCEL_COUNT] = {
...
#define SETGRIDPANELDELTA(ph,ptd)	widget_set_user_delta(ph,(vword_t)ptd)


void	GridPanel_Switch(widget_t widget);

bool_t	GridPanel_SaveFile(widget_t widget, const tchar_t* szFile);
...
bool_t GridPanel_SaveFile(widget_t widget, const tchar_t* szFile)
{
	...
	if (!rt)
	{
		ShowMsg(MSGICO_ERR, _T("保存网格文档错误"));
		return 0;
	}
...
void GridPanel_OnSave(widget_t widget)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_OnSaveAs(widget_t widget)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_OnPrint(widget_t widget)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_OnPreview(widget_t widget)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_OnSchema(widget_t widget)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_OnExport(widget_t widget)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_OnImport(widget_t widget)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_OnExec(widget_t widget)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
	...
	widget_t win = gridctrl_create(NULL, WD_STYLE_DIALOG | WD_STYLE_PAGING, &xr, widget);
...
void GridPanel_OnSelectAll(widget_t widget)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_OnDelete(widget_t widget)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_OnCopy(widget_t widget)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_OnCut(widget_t widget)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_OnPaste(widget_t widget)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_OnRedo(widget_t widget)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);

}

void GridPanel_OnUndo(widget_t widget)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_OnCSSProper(widget_t widget)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_OnSelectAttr(widget_t widget, const tchar_t* attr_name, const tchar_t* attr_val)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_OnFontName(widget_t widget,void* pv)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_OnFontSize(widget_t widget,void* pv)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_OnTextColor(widget_t widget,void* pv)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_OnPaintColor(widget_t widget, void* pv)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_OnDrawColor(widget_t widget, void* pv)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_OnTextBold(widget_t widget)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_OnTextNear(widget_t widget)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_OnTextCenter(widget_t widget)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_OnTextFar(widget_t widget)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_OnAlignNear(widget_t widget)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_OnAlignCenter(widget_t widget)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_OnAlignFar(widget_t widget)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_OnInsertCol(widget_t widget)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_OnInsertRow(widget_t widget)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_OnDeleteRow(widget_t widget)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_OnEraseRows(widget_t widget)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_OnImportCols(widget_t widget)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_OnSelectCols(widget_t widget)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
	...
	widget_t hSQLDlg = SQLViewDlg_Create(_T("检索数据列"), &pd);
...
void GridPanel_OnFreshRows(widget_t widget)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
	...
	if (count)
	{
		widget_t hProperDlg = properdlg_create(_T("设置参数"), ptrProper, g_hMain);
	...
	widget_t hSqlDlg = SQLFetchDlg_Create(_T("检索数据"), &pd);
...
void GridPanel_OnUpdateRows(widget_t widget)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_OnFillCode(widget_t widget)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
	...
	widget_t hProperDlg = properdlg_create(_T("生成代码"), ptrProper, g_hMain);
...
void GridPanel_OnFillHelp(widget_t widget)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
	...
	widget_t hProperDlg = properdlg_create(_T("生成拼音"), ptrProper, g_hMain);
...
void GridPanel_OnAttributes(widget_t widget)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_OnStyleSheet(widget_t widget)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_Title_OnItemChanging(widget_t widget, NOTICE_TITLE* pnt)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_Title_OnItemChanged(widget_t widget, NOTICE_TITLE* pnt)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_Proper_OnEntityUpdate(widget_t widget, NOTICE_PROPER* pnp)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
int GridPanel_OnCreate(widget_t widget, void* data)
{
	...
	widget_set_accel(widget, GRIDPANEL_ACCEL, GRIDPANEL_ACCEL_COUNT);
...
void GridPanel_OnDestroy(widget_t widget)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
int GridPanel_OnClose(widget_t widget)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_OnShow(widget_t widget, bool_t bShow)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_OnCommandFind(widget_t widget, str_find_t* pfd)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_OnParentCommand(widget_t widget, int code, vword_t data)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_OnMenuCommand(widget_t widget, int code, int cid, vword_t data)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
...
void GridPanel_OnNotice(widget_t widget, LPNOTICE phdr)
{
	GridPanelDelta* pdt = GETGRIDPANELDELTA(widget);
	...
	else if (phdr->user == IDC_GRIDPANEL_PROPER)
	{
	...
	else if (phdr->user == IDC_GRIDPANEL_TITLE)
	{
...
/*********************************************************************************************************/
widget_t GridPanel_Create(const tchar_t* wname, dword_t wstyle, const xrect_t* pxr, const tchar_t* fpath)
{
	if_dispatch_t ev = { 0 };
