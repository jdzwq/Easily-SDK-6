...
#define SETIMAGEPANELDELTA(ph,ptd)	widget_set_user_delta(ph,(vword_t)ptd)

#define IMAGEPANEL_ACCEL_COUNT	5
accel_table_t	IMAGEPANEL_ACCEL[IMAGEPANEL_ACCEL_COUNT] = {
...
void	ImagePanel_Switch(widget_t widget);
void	ImagePanel_SetDirty(widget_t widget, bool_t bDirty);
bool_t	ImagePanel_GetDirty(widget_t widget);

bool_t	ImagePanel_SaveFile(widget_t widget, const tchar_t* szFile);
bool_t	ImagePanel_OpenFile(widget_t widget, const tchar_t* szFile);
...
/***************************************************************************************************************/
void ImagePanel_OnSelectAll(widget_t widget)
{
	ImagePanelDelta* pdt = GETIMAGEPANELDELTA(widget);
...
void ImagePanel_OnDelete(widget_t widget)
{
	ImagePanelDelta* pdt = GETIMAGEPANELDELTA(widget);
...
void ImagePanel_OnCopy(widget_t widget)
{
	ImagePanelDelta* pdt = GETIMAGEPANELDELTA(widget);
...
void ImagePanel_OnCut(widget_t widget)
{
	ImagePanelDelta* pdt = GETIMAGEPANELDELTA(widget);
...
void ImagePanel_OnPaste(widget_t widget)
{
	ImagePanelDelta* pdt = GETIMAGEPANELDELTA(widget);
...
void ImagePanel_OnAttach(widget_t widget)
{
	ImagePanelDelta* pdt = GETIMAGEPANELDELTA(widget);
...
void ImagePanel_OnDetach(widget_t widget)
{
	ImagePanelDelta* pdt = GETIMAGEPANELDELTA(widget);
...
void ImagePanel_OnAttributes(widget_t widget)
{
	ImagePanelDelta* pdt = GETIMAGEPANELDELTA(widget);
...
void ImagePanel_OnStyleSheet(widget_t widget)
{
	ImagePanelDelta* pdt = GETIMAGEPANELDELTA(widget);
...
void ImagePanel_Title_OnItemChanging(widget_t widget, NOTICE_TITLE* pnt)
{
	ImagePanelDelta* pdt = GETIMAGEPANELDELTA(widget);
...
void ImagePanel_Title_OnItemChanged(widget_t widget, NOTICE_TITLE* pnt)
{
	ImagePanelDelta* pdt = GETIMAGEPANELDELTA(widget);
...
void ImagePanel_Image_OnLBClick(widget_t widget, NOTICE_IMAGES* pnf)
{
	ImagePanelDelta* pdt = GETIMAGEPANELDELTA(widget);
...
bool_t ImagePanel_SaveFile(widget_t widget, const tchar_t* szFile)
{
	...
	if (!rt)
	{
		ShowMsg(MSGICO_ERR, _T("保存图形文档错误"));
...
void ImagePanel_OnSave(widget_t widget)
{
	ImagePanelDelta* pdt = GETIMAGEPANELDELTA(widget);
...
void ImagePanel_OnSaveAs(widget_t widget)
{
	ImagePanelDelta* pdt = GETIMAGEPANELDELTA(widget);
...
void ImagePanel_OnPrint(widget_t widget)
{
	ImagePanelDelta* pdt = GETIMAGEPANELDELTA(widget);
}

void ImagePanel_OnPreview(widget_t widget)
{
	ImagePanelDelta* pdt = GETIMAGEPANELDELTA(widget);
...
int ImagePanel_OnCreate(widget_t widget, void* data)
{
	...
	widget_set_accel(widget, IMAGEPANEL_ACCEL, IMAGEPANEL_ACCEL_COUNT);
...
void ImagePanel_OnDestroy(widget_t widget)
{
	ImagePanelDelta* pdt = GETIMAGEPANELDELTA(widget);
...
int ImagePanel_OnClose(widget_t widget)
{
	ImagePanelDelta* pdt = GETIMAGEPANELDELTA(widget);
...
void ImagePanel_OnSetFocus(widget_t widget, widget_t hOrg)
{
	ImagePanelDelta* pdt = GETIMAGEPANELDELTA(widget);
...
void ImagePanel_OnShow(widget_t widget, bool_t bShow)
{
	ImagePanelDelta* pdt = GETIMAGEPANELDELTA(widget);
...
void ImagePanel_OnMenuCommand(widget_t widget, int code, int cid, vword_t data)
{
	ImagePanelDelta* pdt = GETIMAGEPANELDELTA(widget);
	void* pv = NULL;
...
void ImagePanel_OnParentCommand(widget_t widget, int code, vword_t data)
{
	ImagePanelDelta* pdt = GETIMAGEPANELDELTA(widget);
...
void ImagePanel_OnNotice(widget_t widget, LPNOTICE phdr)
{
	ImagePanelDelta* pdt = GETIMAGEPANELDELTA(widget);

	if (phdr->user == IDC_IMAGEPANEL_IMAGE)
	{
	...
	else if (phdr->user == IDC_IMAGEPANEL_PROPER)
	{
	...
	else if (phdr->user == IDC_IMAGEPANEL_TITLE)
	{
...
/*********************************************************************************************************/
widget_t ImagePanel_Create(const tchar_t* wname, dword_t wstyle, const xrect_t* pxr, const tchar_t* fpath)
{
	if_dispatch_t ev = { 0 };
