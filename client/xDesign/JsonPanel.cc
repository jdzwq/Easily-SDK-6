...
#define SETJSONPANELDELTA(ph,ptd)	widget_set_user_delta(ph,(vword_t)ptd)

#define JSONPANEL_ACCEL_COUNT	5
accel_table_t JSONPANEL_ACCEL[JSONPANEL_ACCEL_COUNT] = {
...
void	JsonPanel_Switch(widget_t widget);

bool_t	JsonPanel_SaveFile(widget_t widget, const tchar_t* szFile);
bool_t	JsonPanel_OpenFile(widget_t widget, const tchar_t* szFile);
...
/***************************************************************************************************************/
void JsonPanel_OnSelectAll(widget_t widget)
{
	JsonPanelDelta* pdt = GETJSONPANELDELTA(widget);
...
void JsonPanel_OnCopy(widget_t widget)
{
	JsonPanelDelta* pdt = GETJSONPANELDELTA(widget);
...
void JsonPanel_OnCut(widget_t widget)
{
	JsonPanelDelta* pdt = GETJSONPANELDELTA(widget);
...
void JsonPanel_OnPaste(widget_t widget)
{
	JsonPanelDelta* pdt = GETJSONPANELDELTA(widget);
...
void JsonPanel_OnRedo(widget_t widget)
{
	JsonPanelDelta* pdt = GETJSONPANELDELTA(widget);

}

void JsonPanel_OnUndo(widget_t widget)
{
	JsonPanelDelta* pdt = GETJSONPANELDELTA(widget);
...
void JsonPanel_NewFile(widget_t widget)
{
	JsonPanelDelta* pdt = GETJSONPANELDELTA(widget);
...
void JsonPanel_OnSave(widget_t widget)
{
	JsonPanelDelta* pdt = GETJSONPANELDELTA(widget);
...
void JsonPanel_OnSaveAs(widget_t widget)
{
	JsonPanelDelta* pdt = GETJSONPANELDELTA(widget);
...
void JsonPanel_OnExport(widget_t widget)
{
	JsonPanelDelta* pdt = GETJSONPANELDELTA(widget);

}

void JsonPanel_OnSchema(widget_t widget)
{
	JsonPanelDelta* pdt = GETJSONPANELDELTA(widget);

}

void JsonPanel_OnPrint(widget_t widget)
{
	JsonPanelDelta* pdt = GETJSONPANELDELTA(widget);
}

void JsonPanel_OnPreview(widget_t widget)
{
	JsonPanelDelta* pdt = GETJSONPANELDELTA(widget);

}

void JsonPanel_OnExecute(widget_t widget)
{
	JsonPanelDelta* pdt = GETJSONPANELDELTA(widget);
...
int JsonPanel_OnCreate(widget_t widget, void* data)
{
	...
	widget_set_accel(widget, JSONPANEL_ACCEL, JSONPANEL_ACCEL_COUNT);
...
void JsonPanel_OnDestroy(widget_t widget)
{
	JsonPanelDelta* pdt = GETJSONPANELDELTA(widget);
...
int JsonPanel_OnClose(widget_t widget)
{
	JsonPanelDelta* pdt = GETJSONPANELDELTA(widget);
...
void JsonPanel_OnSetFocus(widget_t widget, widget_t hOrg)
{
	JsonPanelDelta* pdt = GETJSONPANELDELTA(widget);
...
void JsonPanel_OnShow(widget_t widget, bool_t bShow)
{
	JsonPanelDelta* pdt = GETJSONPANELDELTA(widget);
...
void JsonPanel_OnCommandFind(widget_t widget, str_find_t* pfd)
{
	JsonPanelDelta* pdt = GETJSONPANELDELTA(widget);
...
void JsonPanel_OnParentCommand(widget_t widget, int code, vword_t data)
{
	JsonPanelDelta* pdt = GETJSONPANELDELTA(widget);
}

void JsonPanel_OnMenuCommand(widget_t widget, int code, int cid, vword_t data)
{
	JsonPanelDelta* pdt = GETJSONPANELDELTA(widget);
	void* pv = NULL;
...
void JsonPanel_OnNotice(widget_t widget, LPNOTICE phdr)
{
	JsonPanelDelta* pdt = GETJSONPANELDELTA(widget);

	if (phdr->user == IDC_JSONPANEL_PROPER)
	{
...
/*********************************************************************************************************/
widget_t JsonPanel_Create(const tchar_t* wname, dword_t wstyle, const xrect_t* pxr, const tchar_t* fpath)
{
	if_dispatch_t ev = { 0 };
