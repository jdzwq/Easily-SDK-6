...
#define SETPLOTPANELDELTA(ph,ptd)	widget_set_user_delta(ph,(vword_t)ptd)

#define PLOTPANEL_ACCEL_COUNT	5
accel_table_t	PLOTPANEL_ACCEL[PLOTPANEL_ACCEL_COUNT] = {
...
void	PlotPanel_Switch(widget_t widget);
void	PlotPanel_SetDirty(widget_t widget, bool_t bDirty);
bool_t	PlotPanel_GetDirty(widget_t widget);

bool_t	PlotPanel_SaveFile(widget_t widget, const tchar_t* szFile);
bool_t	PlotPanel_OpenFile(widget_t widget, const tchar_t* szFile);
...
/***************************************************************************************************************/
void PlotPanel_OnSelectAll(widget_t widget)
{
	PlotPanelDelta* pdt = GETPLOTPANELDELTA(widget);
...
void PlotPanel_OnDelete(widget_t widget)
{
	PlotPanelDelta* pdt = GETPLOTPANELDELTA(widget);
...
void PlotPanel_OnCopy(widget_t widget)
{
	PlotPanelDelta* pdt = GETPLOTPANELDELTA(widget);
...
void PlotPanel_OnCut(widget_t widget)
{
	PlotPanelDelta* pdt = GETPLOTPANELDELTA(widget);
...
void PlotPanel_OnPaste(widget_t widget)
{
	PlotPanelDelta* pdt = GETPLOTPANELDELTA(widget);
...
void PlotPanel_OnAttributes(widget_t widget)
{
	PlotPanelDelta* pdt = GETPLOTPANELDELTA(widget);
...
void PlotPanel_OnStyleSheet(widget_t widget)
{
	PlotPanelDelta* pdt = GETPLOTPANELDELTA(widget);
...
void PlotPanel_Title_OnItemChanging(widget_t widget, NOTICE_TITLE* pnt)
{
	PlotPanelDelta* pdt = GETPLOTPANELDELTA(widget);
...
void PlotPanel_Title_OnItemChanged(widget_t widget, NOTICE_TITLE* pnt)
{
	PlotPanelDelta* pdt = GETPLOTPANELDELTA(widget);
...
void PlotPanel_Plot_OnLBClick(widget_t widget, NOTICE_PLOT* pnf)
{
	PlotPanelDelta* pdt = GETPLOTPANELDELTA(widget);
...
bool_t PlotPanel_SaveFile(widget_t widget, const tchar_t* szFile)
{
	...
	if (!rt)
	{
		ShowMsg(MSGICO_ERR, _T("保存矢量图文档错误"));
...
void PlotPanel_OnSave(widget_t widget)
{
	PlotPanelDelta* pdt = GETPLOTPANELDELTA(widget);
...
void PlotPanel_OnSaveAs(widget_t widget)
{
	PlotPanelDelta* pdt = GETPLOTPANELDELTA(widget);
...
void PlotPanel_OnPrint(widget_t widget)
{
	PlotPanelDelta* pdt = GETPLOTPANELDELTA(widget);
}

void PlotPanel_OnPreview(widget_t widget)
{
	PlotPanelDelta* pdt = GETPLOTPANELDELTA(widget);
...
int PlotPanel_OnCreate(widget_t widget, void* data)
{
	...
	widget_set_accel(widget, PLOTPANEL_ACCEL, PLOTPANEL_ACCEL_COUNT);
...
void PlotPanel_OnDestroy(widget_t widget)
{
	PlotPanelDelta* pdt = GETPLOTPANELDELTA(widget);
...
int PlotPanel_OnClose(widget_t widget)
{
	PlotPanelDelta* pdt = GETPLOTPANELDELTA(widget);
...
void PlotPanel_OnSetFocus(widget_t widget, widget_t hOrg)
{
	PlotPanelDelta* pdt = GETPLOTPANELDELTA(widget);
...
void PlotPanel_OnShow(widget_t widget, bool_t bShow)
{
	PlotPanelDelta* pdt = GETPLOTPANELDELTA(widget);
...
void PlotPanel_OnMenuCommand(widget_t widget, int code, int cid, vword_t data)
{
	PlotPanelDelta* pdt = GETPLOTPANELDELTA(widget);
	void* pv = NULL;
...
void PlotPanel_OnParentCommand(widget_t widget, int code, vword_t data)
{
	PlotPanelDelta* pdt = GETPLOTPANELDELTA(widget);
...
void PlotPanel_OnNotice(widget_t widget, LPNOTICE phdr)
{
	PlotPanelDelta* pdt = GETPLOTPANELDELTA(widget);

	if (phdr->user == IDC_PLOTPANEL_PLOT)
	{
	...
	else if (phdr->user == IDC_PLOTPANEL_PROPER)
	{
	...
	else if (phdr->user == IDC_PLOTPANEL_TITLE)
	{
...
/*********************************************************************************************************/
widget_t PlotPanel_Create(const tchar_t* wname, dword_t wstyle, const xrect_t* pxr, const tchar_t* fpath)
{
	if_dispatch_t ev = { 0 };
