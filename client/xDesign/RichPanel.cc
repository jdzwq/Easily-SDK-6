...
#define SETRICHPANELDELTA(ph,ptd)	widget_set_user_delta(ph,(vword_t)ptd)

#define RICHPANEL_ACCEL_COUNT	5
accel_table_t	RICHPANEL_ACCEL[RICHPANEL_ACCEL_COUNT] = {
...
void	RichPanel_Switch(widget_t widget);

bool_t	RichPanel_SaveFile(widget_t widget, const tchar_t* szFile);
bool_t	RichPanel_OpenFile(widget_t widget, const tchar_t* szFile);
...
/***************************************************************************************************************/
void RichPanel_OnSelectAll(widget_t widget)
{
	RichPanelDelta* pdt = GETRICHPANELDELTA(widget);
...
void RichPanel_OnDelete(widget_t widget)
{
	RichPanelDelta* pdt = GETRICHPANELDELTA(widget);
...
void RichPanel_OnInsert(widget_t widget)
{
	RichPanelDelta* pdt = GETRICHPANELDELTA(widget);
...
void RichPanel_OnCopy(widget_t widget)
{
	RichPanelDelta* pdt = GETRICHPANELDELTA(widget);
...
void RichPanel_OnCut(widget_t widget)
{
	RichPanelDelta* pdt = GETRICHPANELDELTA(widget);
...
void RichPanel_OnPaste(widget_t widget)
{
	RichPanelDelta* pdt = GETRICHPANELDELTA(widget);
...
void RichPanel_OnRedo(widget_t widget)
{
	RichPanelDelta* pdt = GETRICHPANELDELTA(widget);

}

void RichPanel_OnUndo(widget_t widget)
{
	RichPanelDelta* pdt = GETRICHPANELDELTA(widget);
...
void RichPanel_Rich_OnNodeChange(widget_t widget, NOTICE_RICH* pnf)
{
	RichPanelDelta* pdt = GETRICHPANELDELTA(widget);
...
void RichPanel_Proper_OnEntityUpdate(widget_t widget, NOTICE_PROPER* pnp)
{
	RichPanelDelta* pdt = GETRICHPANELDELTA(widget);
...
void RichPanel_OnSave(widget_t widget)
{
	RichPanelDelta* pdt = GETRICHPANELDELTA(widget);
...
void RichPanel_OnSaveAs(widget_t widget)
{
	RichPanelDelta* pdt = GETRICHPANELDELTA(widget);
...
void RichPanel_OnSchema(widget_t widget)
{
	RichPanelDelta* pdt = GETRICHPANELDELTA(widget);
...
void RichPanel_OnExport(widget_t widget)
{
	RichPanelDelta* pdt = GETRICHPANELDELTA(widget);
...
void RichPanel_OnImport(widget_t widget)
{
	RichPanelDelta* pdt = GETRICHPANELDELTA(widget);
...
void RichPanel_OnPrint(widget_t widget)
{
	RichPanelDelta* pdt = GETRICHPANELDELTA(widget);
}

void RichPanel_OnPreview(widget_t widget)
{
	RichPanelDelta* pdt = GETRICHPANELDELTA(widget);
...
int RichPanel_OnCreate(widget_t widget, void* data)
{
	...
	widget_set_accel(widget, RICHPANEL_ACCEL, RICHPANEL_ACCEL_COUNT);
...
void RichPanel_OnDestroy(widget_t widget)
{
	RichPanelDelta* pdt = GETRICHPANELDELTA(widget);
...
int RichPanel_OnClose(widget_t widget)
{
	RichPanelDelta* pdt = GETRICHPANELDELTA(widget);
...
void RichPanel_OnSetFocus(widget_t widget, widget_t hOrg)
{
	RichPanelDelta* pdt = GETRICHPANELDELTA(widget);
...
void RichPanel_OnShow(widget_t widget, bool_t bShow)
{
	RichPanelDelta* pdt = GETRICHPANELDELTA(widget);
...
void RichPanel_OnCommandFind(widget_t widget, str_find_t* pfd)
{
	RichPanelDelta* pdt = GETRICHPANELDELTA(widget);
...
void RichPanel_OnParentCommand(widget_t widget, int code, vword_t data)
{
	RichPanelDelta* pdt = GETRICHPANELDELTA(widget);
...
void RichPanel_OnMenuCommand(widget_t widget, int code, int cid, vword_t data)
{
	RichPanelDelta* pdt = GETRICHPANELDELTA(widget);
	void* pv = NULL;
...
void RichPanel_OnNotice(widget_t widget, LPNOTICE phdr)
{
	RichPanelDelta* pdt = GETRICHPANELDELTA(widget);

	if (phdr->user == IDC_RICHPANEL_RICH)
	{
	...
	else if (phdr->user == IDC_RICHPANEL_PROPER)
	{
...
/*********************************************************************************************************/
widget_t RichPanel_Create(const tchar_t* wname, dword_t wstyle, const xrect_t* pxr, const tchar_t* fpath)
{
	if_dispatch_t ev = { 0 };
