...
#define SETSQLFETCHDLGDELTA(ph,ptd)	widget_set_user_delta(ph,(vword_t)ptd)

void SQLFetchDlg_OnOK(widget_t widget)
{
...
void SQLFetchDlg_OnCancel(widget_t widget)
{
	SQLFetchDlgDelta* pdt = GETSQLFETCHDLGDELTA(widget);
...
/*********************************************************************************************/
int SQLFetchDlg_OnCreate(widget_t widget, void* data)
{
...
void SQLFetchDlg_OnDestroy(widget_t widget)
{
	SQLFetchDlgDelta* pdt = GETSQLFETCHDLGDELTA(widget);
...
void SQLFetchDlg_OnSize(widget_t widget, int code, const xsize_t* pxs)
{
	SQLFetchDlgDelta* pdt = GETSQLFETCHDLGDELTA(widget);
...
void SQLFetchDlg_OnMenuCommand(widget_t widget, int code, int cid, vword_t data)
{
	SQLFetchDlgDelta* pdt = GETSQLFETCHDLGDELTA(widget);
...
void SQLFetchDlg_OnPaint(widget_t widget, visual_t dc, const xrect_t* pxr)
{
	SQLFetchDlgDelta* pdt = GETSQLFETCHDLGDELTA(widget);
...
/************************************************************************************************************/
widget_t SQLFetchDlg_Create(const tchar_t* title, SQLFETCHDLG_PARAM* ppd)
{
	widget_t widget;
