...
#define SETSQLUPDATEDLGDELTA(ph,ptd)	widget_set_user_delta(ph,(vword_t)ptd)

void SQLUpdateDlg_OnOK(widget_t widget)
{
...
void SQLUpdateDlg_OnCancel(widget_t widget)
{
	SQLUpdateDlgDelta* pdt = GETSQLUPDATEDLGDELTA(widget);
...
/*********************************************************************************************/
int SQLUpdateDlg_OnCreate(widget_t widget, void* data)
{
...
void SQLUpdateDlg_OnDestroy(widget_t widget)
{
	SQLUpdateDlgDelta* pdt = GETSQLUPDATEDLGDELTA(widget);
...
void SQLUpdateDlg_OnSize(widget_t widget, int code, const xsize_t* pxs)
{
	SQLUpdateDlgDelta* pdt = GETSQLUPDATEDLGDELTA(widget);
...
void SQLUpdateDlg_OnMenuCommand(widget_t widget, int code, int cid, vword_t data)
{
	SQLUpdateDlgDelta* pdt = GETSQLUPDATEDLGDELTA(widget);
...
void SQLUpdateDlg_OnPaint(widget_t widget, visual_t dc, const xrect_t* pxr)
{
	SQLUpdateDlgDelta* pdt = GETSQLUPDATEDLGDELTA(widget);
...
/************************************************************************************************************/
widget_t SQLUpdateDlg_Create(const tchar_t* title, SQLUPDATEDLG_PARAM* ppd)
{
	widget_t widget;
