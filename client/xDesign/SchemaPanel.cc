...
#define SETSCHEMAPANELDELTA(ph,ptd)	widget_set_user_delta(ph,(vword_t)ptd)

bool_t	SchemaPanel_SaveFile(widget_t widget, const tchar_t* szFile);
bool_t	SchemaPanel_OpenFile(widget_t widget, const tchar_t* szFile);

LINKPTR SchemaPanel_GetDocument(widget_t widget);

/***************************************************************************************/

void SchemaPanel_Switch(widget_t widget)
{
...
bool_t SchemaPanel_OpenFile(widget_t widget, const tchar_t* szFile)
{
	...
	if (!load_xml_doc_from_file(ptr_xml, NULL, szFile))
	{
		...
		ShowMsg(MSGICO_ERR, _T("打开XML文档失败！"));
		return 0;
	}
...
/*********************************************************************************************************/
void SchemaPanel_OnSelectAll(widget_t widget)
{
	SchemaPanelDelta* pdt = GETSCHEMAPANELDELTA(widget);
...
void SchemaPanel_OnDelete(widget_t widget)
{
	SchemaPanelDelta* pdt = GETSCHEMAPANELDELTA(widget);
...
void SchemaPanel_OnCopy(widget_t widget)
{
	SchemaPanelDelta* pdt = GETSCHEMAPANELDELTA(widget);
...
void SchemaPanel_OnCut(widget_t widget)
{
	SchemaPanelDelta* pdt = GETSCHEMAPANELDELTA(widget);
...
void SchemaPanel_OnPaste(widget_t widget)
{
	SchemaPanelDelta* pdt = GETSCHEMAPANELDELTA(widget);
...
void SchemaPanel_OnRedo(widget_t widget)
{
	SchemaPanelDelta* pdt = GETSCHEMAPANELDELTA(widget);

}

void SchemaPanel_OnUndo(widget_t widget)
{
	SchemaPanelDelta* pdt = GETSCHEMAPANELDELTA(widget);
...
void SchemaPanel_Schema_OnRBClick(widget_t widget, NOTICE_MEMO* pnf)
{
	SchemaPanelDelta* pdt = GETSCHEMAPANELDELTA(widget);
...
void SchemaPanel_Schema_OnLBClick(widget_t widget, NOTICE_MEMO* pnf)
{
	SchemaPanelDelta* pdt = GETSCHEMAPANELDELTA(widget);

}

void SchemaPanel_OnSave(widget_t widget)
{
	SchemaPanelDelta* pdt = GETSCHEMAPANELDELTA(widget);
...
void SchemaPanel_OnSaveAs(widget_t widget)
{
	SchemaPanelDelta* pdt = GETSCHEMAPANELDELTA(widget);
...
void SchemaPanel_OnPrint(widget_t widget)
{
	SchemaPanelDelta* pdt = GETSCHEMAPANELDELTA(widget);

}

void SchemaPanel_OnPreview(widget_t widget)
{
	SchemaPanelDelta* pdt = GETSCHEMAPANELDELTA(widget);
...
/***********************************************************************************************************/
int SchemaPanel_OnCreate(widget_t widget, void* data)
{
...
void SchemaPanel_OnDestroy(widget_t widget)
{
	SchemaPanelDelta* pdt = GETSCHEMAPANELDELTA(widget);
...
void SchemaPanel_OnShow(widget_t widget, bool_t bShow)
{
	SchemaPanelDelta* pdt = GETSCHEMAPANELDELTA(widget);
...
int SchemaPanel_OnClose(widget_t widget)
{
	SchemaPanelDelta* pdt = GETSCHEMAPANELDELTA(widget);
...
void SchemaPanel_OnSize(widget_t widget, int code, const xsize_t* pxs)
{
	SchemaPanelDelta* pdt = GETSCHEMAPANELDELTA(widget);
	xrect_t xr;
...
void SchemaPanel_OnMenuCommand(widget_t widget, int code, int cid, vword_t data)
{
	SchemaPanelDelta* pdt = GETSCHEMAPANELDELTA(widget);
...
void SchemaPanel_OnParentCommand(widget_t widget, int code, vword_t data)
{
	SchemaPanelDelta* pdt = GETSCHEMAPANELDELTA(widget);
...
void SchemaPanel_OnNotice(widget_t widget, LPNOTICE phdr)
{
	SchemaPanelDelta* pdt = GETSCHEMAPANELDELTA(widget);

	if (phdr->user == IDC_SCHEMAPANEL_SCHEMA)
	{
...
/**************************************************************************************************************/
widget_t SchemaPanel_Create(const tchar_t* wname, dword_t wstyle, const xrect_t* pxr, const tchar_t* fpath)
{
	if_dispatch_t ev = { 0 };
