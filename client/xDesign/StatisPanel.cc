...
#define SETSTATISPANELDELTA(ph,ptd)	widget_set_user_delta(ph,(vword_t)ptd)

#define STATISPANEL_ACCEL_COUNT	5
accel_table_t	STATISPANEL_ACCEL[STATISPANEL_ACCEL_COUNT] = {
...
bool_t	StatisPanel_SaveFile(widget_t widget, const tchar_t* szFile);
...
bool_t StatisPanel_SaveFile(widget_t widget, const tchar_t* szFile)
{
	...
	if (!rt)
	{
		ShowMsg(MSGICO_ERR, _T("保存图表文档错误"));
...
void StatisPanel_OnSave(widget_t widget)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
...
void StatisPanel_OnSaveAs(widget_t widget)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
...
void StatisPanel_OnPrint(widget_t widget)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
}

void StatisPanel_OnPreview(widget_t widget)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
...
void StatisPanel_OnSchema(widget_t widget)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
...
void StatisPanel_OnExport(widget_t widget)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
...
void StatisPanel_OnImport(widget_t widget)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
...
void StatisPanel_OnExec(widget_t widget)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
	...
	widget_t win = statisctrl_create(NULL, WD_STYLE_DIALOG | WD_STYLE_PAGING, &xr, widget);
...
void StatisPanel_OnSelectAll(widget_t widget)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
...
void StatisPanel_OnDelete(widget_t widget)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
...
void StatisPanel_OnCut(widget_t widget)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
...
void StatisPanel_OnPaste(widget_t widget)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
...
void StatisPanel_OnRedo(widget_t widget)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);

}

void StatisPanel_OnUndo(widget_t widget)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
...
void StatisPanel_OnSelectAttr(widget_t widget, const tchar_t* attr_name, const tchar_t* attr_val)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
...
void StatisPanel_OnFontName(widget_t widget, void* pv)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
...
void StatisPanel_OnFontSize(widget_t widget, void* pv)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
...
void StatisPanel_OnTextColor(widget_t widget, void* pv)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
...
void StatisPanel_OnPaintColor(widget_t widget, void* pv)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
...
void StatisPanel_OnDrawColor(widget_t widget, void* pv)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
...
void StatisPanel_OnTextNear(widget_t widget)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
...
void StatisPanel_OnTextBold(widget_t widget)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
...
void StatisPanel_OnTextCenter(widget_t widget)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
...
void StatisPanel_OnTextFar(widget_t widget)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
...
void StatisPanel_OnInsertGax(widget_t widget)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
...
void StatisPanel_OnInsertYax(widget_t widget)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
...
void StatisPanel_OnInsertXax(widget_t widget)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
...
void StatisPanel_OnImportXaxs(widget_t widget)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
...
void StatisPanel_OnUpdateXaxs(widget_t widget)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
...
void StatisPanel_OnAttributes(widget_t widget)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
...
void StatisPanel_OnStyleSheet(widget_t widget)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
...
void StatisPanel_Title_OnItemChanging(widget_t widget, NOTICE_TITLE* pnt)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
...
void StatisPanel_Title_OnItemChanged(widget_t widget, NOTICE_TITLE* pnt)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
...
void StatisPanel_Proper_OnEntityUpdate(widget_t widget, NOTICE_PROPER* pnp)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
...
int StatisPanel_OnCreate(widget_t widget, void* data)
{
	...
	widget_set_accel(widget, STATISPANEL_ACCEL, STATISPANEL_ACCEL_COUNT);
...
void StatisPanel_OnDestroy(widget_t widget)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
...
int StatisPanel_OnClose(widget_t widget)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
...
void StatisPanel_OnShow(widget_t widget, bool_t bShow)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
...
void StatisPanel_OnCommandFind(widget_t widget, str_find_t* pfd)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
...
void StatisPanel_OnParentCommand(widget_t widget, int code, vword_t data)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
...
void StatisPanel_OnMenuCommand(widget_t widget, int code, int cid, vword_t data)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
...
void StatisPanel_OnNotice(widget_t widget, LPNOTICE phdr)
{
	StatisPanelDelta* pdt = GETSTATISPANELDELTA(widget);
	...
	else if (phdr->user == IDC_STATISPANEL_PROPER)
	{
	...
	else if (phdr->user == IDC_STATISPANEL_TITLE)
	{
...
/*********************************************************************************************************/
widget_t StatisPanel_Create(const tchar_t* wname, dword_t wstyle, const xrect_t* pxr, const tchar_t* fpath)
{
	if_dispatch_t ev = { 0 };
