...
#define SETTOPOGPANELDELTA(ph,ptd)	widget_set_user_delta(ph,(vword_t)ptd)

#define TOPOGPANEL_ACCEL_COUNT	5
accel_table_t	TOPOGPANEL_ACCEL[TOPOGPANEL_ACCEL_COUNT] = {
...
bool_t	TopogPanel_SaveFile(widget_t widget, const tchar_t* szFile);
...
/***************************************************************************************************************/
void TopogPanel_OnSelectAll(widget_t widget)
{
	TopogPanelDelta* pdt = GETTOPOGPANELDELTA(widget);
...
void TopogPanel_OnInsert(widget_t widget)
{
	TopogPanelDelta* pdt = GETTOPOGPANELDELTA(widget);
...
void TopogPanel_OnDelete(widget_t widget)
{
	TopogPanelDelta* pdt = GETTOPOGPANELDELTA(widget);
...
void TopogPanel_OnCopy(widget_t widget)
{
	TopogPanelDelta* pdt = GETTOPOGPANELDELTA(widget);
...
void TopogPanel_OnCut(widget_t widget)
{
	TopogPanelDelta* pdt = GETTOPOGPANELDELTA(widget);
...
void TopogPanel_OnPaste(widget_t widget)
{
	TopogPanelDelta* pdt = GETTOPOGPANELDELTA(widget);
...
void TopogPanel_OnRedo(widget_t widget)
{
	TopogPanelDelta* pdt = GETTOPOGPANELDELTA(widget);

}

void TopogPanel_OnUndo(widget_t widget)
{
	TopogPanelDelta* pdt = GETTOPOGPANELDELTA(widget);
...
void TopogPanel_OnAttach(widget_t widget)
{
	TopogPanelDelta* pdt = GETTOPOGPANELDELTA(widget);
...
void TopogPanel_OnDetach(widget_t widget)
{
	TopogPanelDelta* pdt = GETTOPOGPANELDELTA(widget);
...
void TopogPanel_OnAttributes(widget_t widget)
{
	TopogPanelDelta* pdt = GETTOPOGPANELDELTA(widget);
...
void TopogPanel_OnStyleSheet(widget_t widget)
{
	TopogPanelDelta* pdt = GETTOPOGPANELDELTA(widget);
...
void TopogPanel_Title_OnItemChanging(widget_t widget, NOTICE_TITLE* pnt)
{
	TopogPanelDelta* pdt = GETTOPOGPANELDELTA(widget);
...
void TopogPanel_Title_OnItemChanged(widget_t widget, NOTICE_TITLE* pnt)
{
	TopogPanelDelta* pdt = GETTOPOGPANELDELTA(widget);
...
void TopogPanel_OnSave(widget_t widget)
{
	TopogPanelDelta* pdt = GETTOPOGPANELDELTA(widget);
...
void TopogPanel_OnSaveAs(widget_t widget)
{
	TopogPanelDelta* pdt = GETTOPOGPANELDELTA(widget);
...
void TopogPanel_OnPrint(widget_t widget)
{
	TopogPanelDelta* pdt = GETTOPOGPANELDELTA(widget);
}

void TopogPanel_OnPreview(widget_t widget)
{
	TopogPanelDelta* pdt = GETTOPOGPANELDELTA(widget);
...
int TopogPanel_OnCreate(widget_t widget, void* data)
{
	...
	widget_set_accel(widget, TOPOGPANEL_ACCEL, TOPOGPANEL_ACCEL_COUNT);
...
void TopogPanel_OnDestroy(widget_t widget)
{
	TopogPanelDelta* pdt = GETTOPOGPANELDELTA(widget);
...
int TopogPanel_OnClose(widget_t widget)
{
	TopogPanelDelta* pdt = GETTOPOGPANELDELTA(widget);
...
void TopogPanel_OnSetFocus(widget_t widget, widget_t hOrg)
{
	TopogPanelDelta* pdt = GETTOPOGPANELDELTA(widget);
...
void TopogPanel_OnShow(widget_t widget, bool_t bShow)
{
	TopogPanelDelta* pdt = GETTOPOGPANELDELTA(widget);
...
void TopogPanel_OnCommandFind(widget_t widget, str_find_t* pfd)
{
	TopogPanelDelta* pdt = GETTOPOGPANELDELTA(widget);
...
void TopogPanel_OnParentCommand(widget_t widget, int code, vword_t data)
{
	TopogPanelDelta* pdt = GETTOPOGPANELDELTA(widget);
...
void TopogPanel_OnMenuCommand(widget_t widget, int code, int cid, vword_t data)
{
	TopogPanelDelta* pdt = GETTOPOGPANELDELTA(widget);
	void* pv = NULL;
...
void TopogPanel_OnNotice(widget_t widget, LPNOTICE phdr)
{
	TopogPanelDelta* pdt = GETTOPOGPANELDELTA(widget);
	...
	else if (phdr->user == IDC_TOPOGPANEL_PROPER)
	{
	...
	else if (phdr->user == IDC_TOPOGPANEL_TITLE)
	{
...
/*********************************************************************************************************/
widget_t TopogPanel_Create(const tchar_t* wname, dword_t wstyle, const xrect_t* pxr, const tchar_t* fpath)
{
	if_dispatch_t ev = { 0 };
