...
#define SETXMLPANELDELTA(ph,ptd)	widget_set_user_delta(ph,(vword_t)ptd)

#define XMLPANEL_ACCEL_COUNT	5
accel_table_t	XMLPANEL_ACCEL[XMLPANEL_ACCEL_COUNT] = {
...
void	XMLPanel_Switch(widget_t widget);

bool_t	XMLPanel_SaveFile(widget_t widget, const tchar_t* szFile);
bool_t	XMLPanel_OpenFile(widget_t widget, const tchar_t* szFile);
...
/***************************************************************************************************************/
void XMLPanel_OnSelectAll(widget_t widget)
{
	XMLPanelDelta* pdt = GETXMLPANELDELTA(widget);
...
void XMLPanel_OnCopy(widget_t widget)
{
	XMLPanelDelta* pdt = GETXMLPANELDELTA(widget);
...
void XMLPanel_OnCut(widget_t widget)
{
	XMLPanelDelta* pdt = GETXMLPANELDELTA(widget);
...
void XMLPanel_OnPaste(widget_t widget)
{
	XMLPanelDelta* pdt = GETXMLPANELDELTA(widget);
...
void XMLPanel_OnRedo(widget_t widget)
{
	XMLPanelDelta* pdt = GETXMLPANELDELTA(widget);

}

void XMLPanel_OnUndo(widget_t widget)
{
	XMLPanelDelta* pdt = GETXMLPANELDELTA(widget);
...
void XMLPanel_NewFile(widget_t widget)
{
	XMLPanelDelta* pdt = GETXMLPANELDELTA(widget);
...
void XMLPanel_OnSave(widget_t widget)
{
	XMLPanelDelta* pdt = GETXMLPANELDELTA(widget);
...
void XMLPanel_OnSaveAs(widget_t widget)
{
	XMLPanelDelta* pdt = GETXMLPANELDELTA(widget);
...
void XMLPanel_OnExport(widget_t widget)
{
	XMLPanelDelta* pdt = GETXMLPANELDELTA(widget);

}

void XMLPanel_OnSchema(widget_t widget)
{
	XMLPanelDelta* pdt = GETXMLPANELDELTA(widget);

}

void XMLPanel_OnPrint(widget_t widget)
{
	XMLPanelDelta* pdt = GETXMLPANELDELTA(widget);
}

void XMLPanel_OnPreview(widget_t widget)
{
	XMLPanelDelta* pdt = GETXMLPANELDELTA(widget);

}

void XMLPanel_OnExecute(widget_t widget)
{
	XMLPanelDelta* pdt = GETXMLPANELDELTA(widget);
...
int XMLPanel_OnCreate(widget_t widget, void* data)
{
	...
	widget_set_accel(widget, XMLPANEL_ACCEL, XMLPANEL_ACCEL_COUNT);
...
void XMLPanel_OnDestroy(widget_t widget)
{
	XMLPanelDelta* pdt = GETXMLPANELDELTA(widget);
...
int XMLPanel_OnClose(widget_t widget)
{
	XMLPanelDelta* pdt = GETXMLPANELDELTA(widget);
...
void XMLPanel_OnSetFocus(widget_t widget, widget_t hOrg)
{
	XMLPanelDelta* pdt = GETXMLPANELDELTA(widget);
...
void XMLPanel_OnShow(widget_t widget, bool_t bShow)
{
	XMLPanelDelta* pdt = GETXMLPANELDELTA(widget);
...
void XMLPanel_OnCommandFind(widget_t widget, str_find_t* pfd)
{
	XMLPanelDelta* pdt = GETXMLPANELDELTA(widget);
...
void XMLPanel_OnParentCommand(widget_t widget, int code, vword_t data)
{
	XMLPanelDelta* pdt = GETXMLPANELDELTA(widget);
}

void XMLPanel_OnMenuCommand(widget_t widget, int code, int cid, vword_t data)
{
	XMLPanelDelta* pdt = GETXMLPANELDELTA(widget);
	void* pv = NULL;
...
void XMLPanel_OnNotice(widget_t widget, LPNOTICE phdr)
{
	XMLPanelDelta* pdt = GETXMLPANELDELTA(widget);

	if (phdr->user == IDC_XMLPANEL_PROPER)
	{
...
/*********************************************************************************************************/
widget_t XMLPanel_Create(const tchar_t* wname, dword_t wstyle, const xrect_t* pxr, const tchar_t* fpath)
{
	if_dispatch_t ev = { 0 };
