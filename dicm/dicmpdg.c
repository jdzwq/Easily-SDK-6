...
static bool_t _on_parse_data(void* pp, dword_t tag, const byte_t* vr, const byte_t* vf, dword_t vl)
{
	...
	{
	case 0x00080060:
		a_xsncpy((schar_t*)pa->di.moda, (schar_t*)vf, 16);
		break;
	...
	case 0x00281050: //windows center
		pa->di.win_center = (int)(xstof(tval) * 10000);
		break;
	case 0x00281051: //windows width
		pa->di.win_width = (int)(xstof(tval) * 10000);
		break;
	case 0x00281052: //rescale Intercept
		pa->di.win_inter = (int)(xstof(tval) * 10000);
		break;
	case 0x00281053: //rescale Slope
		pa->di.win_slope = (int)(xstof(tval) * 10000);
		break;
