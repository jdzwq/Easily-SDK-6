...
const dicm_vr_t DICM_VR[] = {
	{ _T("AE"), 0, 16 }, //Application Entity
	{ _T("AS"), 4, 4 }, //Age String
	{ _T("AT"), 4, 4 }, //Attribute Tag
	{ _T("CS"), 0, 16 }, //Code String
	{ _T("DA"), 8, 8 }, //Date:19700101
	{ _T("DS"), 0, 16 }, //Decimal String
	{ _T("DT"), 26, 26 }, //Date Time: CCYYMMEDDHHMMSS.FFFFFF&ZZZZ
	{ _T("FL"), 4, 4 }, //Floating Point Single
	{ _T("FD"), 8, 8 }, //Floating Point Double
	{ _T("IS"), 0, 12 }, //Integer String
	{ _T("LO"), 0, 64 }, //Long String
	{ _T("LT"), 0, 10240 }, //Long Text
	{ _T("OB"), 0, MAX_LONG }, //Other Byte String
	{ _T("OW"), 0, MAX_SHORT }, //Other Word String
	{ _T("PN"), 0, 64 }, //Person Name
	{ _T("SH"), 0, 16 }, //Short String
	{ _T("SL"), 4, 4 }, //Signed Long
	{ _T("SQ"), 0, MAX_LONG }, //Sequence of Items
	{ _T("SS"), 2, 2 }, //Signed Short
	{ _T("ST"), 0, 1024 }, //Short Text
	{ _T("TM"), 16, 16 }, //Time: hhmmss.frac
	{ _T("UI"), 0, 64 }, //Unique Identifier
	{ _T("UL"), 4, 4 }, //Unsigned Long
	{ _T("US"), 4, 2 } //Unsigned Short
};


const dicm_item_t DICM_ITEMS[] = {
	{ 0x00000000, _T("UL"), _T("CommandGroupLength") },
	...
	{ 0x70010000, _T("UL"), _T("DectorGroupLength") },
	{ 0x70010001, _T("ST"), _T("DectorManufacturer") },
	{ 0x70010002, _T("ST"), _T("DectorProductName") },
	{ 0x70010003, _T("UI"), _T("DectorSerialNumber") },
	{ 0x70010004, _T("CS"), _T("DectorAddressType") },
	{ 0x70010005, _T("ST"), _T("DectorAddress") },
	{ 0x70010006, _T("UI"), _T("DectorUUID") },
	{ 0x70010007, _T("OB"), _T("DectorInput") },
	{ 0x70010008, _T("OB"), _T("DectorOutput") },
	{ 0x70010099, _T("SQ"), _T("SensorSequence") },

	{ 0x70030000, _T("UL"), _T("SensorGroupLength") },
	{ 0x70030001, _T("CS"), _T("SensorType") },
	{ 0x70030002, _T("ST"), _T("SensorSpecs") },
	{ 0x70030003, _T("UI"), _T("SensorSerialNumber") },
	{ 0x70030004, _T("SH"), _T("SensorUnit") },
	{ 0x70030005, _T("DS"), _T("SensorPrecision") },
	{ 0x70030006, _T("DS"), _T("SensorPositiveDeviation") },
	{ 0x70030007, _T("DS"), _T("SensorMinusDeviation") },
	{ 0x70030010, _T("OB"), _T("SensorInput") },
	{ 0x70030011, _T("OB"), _T("SensorOutput") },
	{ 0x70030099, _T("SQ"), _T("IOSequence") },

	{ 0x70050000, _T("UL"), _T("CommandGroupLength") },
	{ 0x70050001, _T("OB"), _T("CommandInput") },
	{ 0x70050002, _T("OB"), _T("CommandOutput") },

	{ 0x70070000, _T("UL"), _T("GeoGroupLength") },
	{ 0x70070001, _T("FD"), _T("Longitude") },
	{ 0x70070002, _T("FD"), _T("Latitude") },
	{ 0x70070003, _T("FD"), _T("Altitude") },
...
const dword_t DICM_GRTAGS[] = {
	0x00000000, //GroupLength
	0x00100000, //PatientGroupLength
	0x70010000, //DectorGroupLength
	0x70030000, //SensorGroupLength
	0x70050000 //CommandGroupLength
};
...
const dword_t DICM_SQTAGS[] = {
	...
	0x70010099, //SensorSequence
	0x70030099, //CommandSequence
};
...
bool_t dicm_is_group(dword_t tag)
{
	return (tag & 0x0000FFFF) ? 0 : 1;
}
...
void dicm_bytes_turn(byte_t vr[2], byte_t* vf, dword_t vl)
{
	int i;
...
{
	if (a_xsncmp((schar_t*)syn, "1.2.840.10008.1.2.1", a_xslen("1.2.840.10008.1.2.1")) == 0)
	{
		return 0;
	}
	else if (a_xsncmp((schar_t*)syn, "1.2.840.10008.1.2.2", a_xslen("1.2.840.10008.1.2.2")) == 0)
	{
		return 0;
	}
	else if (a_xsncmp((schar_t*)syn, "1.2.840.10008.1.2", a_xslen("1.2.840.10008.1.2")) == 0)
	{
		return 1;
	}
...
{
	if (a_xsncmp((schar_t*)syn, "1.2.840.10008.1.2.2", a_xslen("1.2.840.10008.1.2.2")) == 0)
	{
		return 1;
	}
	else if (a_xsncmp((schar_t*)syn, "1.2.840.10008.1.2.1", a_xslen("1.2.840.10008.1.2.1")) == 0)
	{
		return 0;
	}
	else if (a_xsncmp((schar_t*)syn, "1.2.840.10008.1.2", a_xslen("1.2.840.10008.1.2")) == 0)
