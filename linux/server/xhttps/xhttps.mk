...
# 1. make -f xhttps.so.mk test --if need to creating some directory or file-list
# 2. make -f xhttps.so.mk clean
# 3. make -f xhttps.so.mk
# 4. make -f xhttps.so.mk install
#-----------------------------------------------------------------------------
CC = gcc
