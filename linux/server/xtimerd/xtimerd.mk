...
# 1. make -f xtimerd.so.mk test --if need to creating some directory or file-list
# 2. make -f xtimerd.so.mk clean
# 3. make -f xtimerd.so.mk
# 4. make -f xtimerd.so.mk install
#-----------------------------------------------------------------------------
CC = gcc
...
$(OBJ_PATH)/%.o : $(SRC_PATH)/xtimerd/linux/%.cc
	$(CC) $(CFLAGS) -c $< -o $@ -I $(INC_PATH)
