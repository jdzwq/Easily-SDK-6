...
# 1. nmake /f xudps.so.mk test --if need to creating some directory or file-list
# 2. nmake /f xudps.so.mk clean
# 3. nmake /f xudps.so.mk
# 4. nmake /f xudps.so.mk install
#-----------------------------------------------------------------------------
CC = gcc
