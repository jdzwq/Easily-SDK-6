...
# 1. make -f gen_gly.mk tools --if need to creating some directory or file-list
# 2. make -f gen_gly.mk clean
# 3. make -f gen_gly.mk
# 4. make -f gen_gly.mk install
#-----------------------------------------------------------------------------
CC = clang
...
DIRS = $(wildcard $(SRC_PATH)/gen_gly/gen_freetype.cc)
SRCS = $(notdir $(DIRS))
COBS = $(patsubst %.cc, %.o, $(SRCS))
OBJS = $(addprefix $(OBJ_PATH)/,$(COBS))

$(OBJ_PATH)/%.o : $(SRC_PATH)/gen_gly/%.cc
