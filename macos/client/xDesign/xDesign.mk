...
# 1. make -f xDesign.mk tools --if need to creating some directory or file-list
# 2. make -f xDesign.mk clean
# 3. make -f xDesign.mk
# 4. make -f xDesign.mk install
#-----------------------------------------------------------------------------
CC = clang
...
all : $(OBJS)
	rm -f $@
	$(CC) -o $(OBJ_PATH)/$(MODULE) $(OBJS) -L $(LIB_PATH) -lxdk -lxdg -lxdu -lxdl -lxdc \
	-Wl,-rpath $(LIB_PATH)
