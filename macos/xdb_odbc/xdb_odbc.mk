...
# 1. make -f xdb_odbc.mk test --if need to creating some directory or file-list
# 2. make -f xdb_odbc.mk clean
# 3. make -f xdb_odbc.mk
# 4. make -f xdb_odbc.mk install
#-----------------------------------------------------------------------------
CC = clang
...
LIBS = -lxdk -lxdg -lxdl -L $(LIB_ODBC) -lodbc
DIRS = $(wildcard $(SRC_PATH)/odbc/*.c)
SRCS = $(notdir $(DIRS))
COBS = $(patsubst %.c, %.o, $(SRCS))
OBJS = $(addprefix $(OBJ_PATH)/,$(COBS))

$(OBJ_PATH)/%.o : $(SRC_PATH)/odbc/%.c
