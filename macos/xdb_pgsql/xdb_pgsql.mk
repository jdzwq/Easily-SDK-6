...
# 1. make -f xdb_pgsql.mk test --if need to creating some directory or file-list
# 2. make -f xdb_pgsql.mk clean
# 3. make -f xdb_pgsql.mk
# 4. make -f xdb_pgsql.mk install
#-----------------------------------------------------------------------------
CC = clang
