...
# begin GNU MAKE file
# making order:
# 1. make -f xdb_pq.so.mk test --if need to creating some directory or file-list
# 2. make -f xdb_pq.so.mk clean
# 3. make -f xdb_pq.so.mk
# 4. make -f xdb_pq.so.mk install
#-----------------------------------------------------------------------------
CC = clang
...
INC_PQ = /usr/local/pq/include
LIB_PQ = /usr/local/pq/lib
