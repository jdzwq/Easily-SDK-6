...
# begin GNU MAKE file
# making order:
# 1. make -f xdb_sqlite.so.mk test --if need to creating some directory or file-list
# 2. make -f xdb_sqlite.so.mk clean
# 3. make -f xdb_sqlite.so.mk
# 4. make -f xdb_sqlite.so.mk install
#-----------------------------------------------------------------------------
CC = clang
