...
# begin GNU MAKE file
# making order:
# 1. make -f xdb_stub.so.mk test --if need to creating some directory or file-list
# 2. make -f xdb_stub.so.mk clean
# 3. make -f xdb_stub.so.mk
# 4. make -f xdb_stub.so.mk install
#-----------------------------------------------------------------------------
CC = clang
