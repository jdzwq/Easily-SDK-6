...
typedef struct ctr_drbg_context
{
	...
	uint32_t entropy_len;         /*!< The amount of entropy grabbed on each
 ...
 */
OEM_EXP_API void ctr_drbg_init( ctr_drbg_context *ctx );
 ...
 */
OEM_EXP_API int ctr_drbg_seed(ctr_drbg_context *ctx,
                   int (*f_entropy)(void *, unsigned char *, uint32_t),
                   void *p_entropy,
 ...
 */
OEM_EXP_API void ctr_drbg_free(ctr_drbg_context *ctx);
 ...
 */
OEM_EXP_API void ctr_drbg_set_prediction_resistance(ctr_drbg_context *ctx,
                                         int resistance );
 ...
 */
OEM_EXP_API void ctr_drbg_set_entropy_len(ctr_drbg_context *ctx,
                               uint32_t len );
 ...
 */
OEM_EXP_API void ctr_drbg_set_reseed_interval(ctr_drbg_context *ctx,
                                   int interval );
 ...
 * \return              #ERR_CTR_DRBG_ENTROPY_SOURCE_FAILED on failure.
 */
OEM_EXP_API int ctr_drbg_reseed(ctr_drbg_context *ctx,
 ...
 */
OEM_EXP_API int ctr_drbg_update(ctr_drbg_context *ctx,
 ...
 */
OEM_EXP_API int ctr_drbg_random_with_add(void *p_rng,
 ...
 *                      #ERR_CTR_DRBG_REQUEST_TOO_BIG on failure.
 */
OEM_EXP_API int ctr_drbg_random(void *p_rng,
                     unsigned char *output, uint32_t output_len );
 ...
 */
OEM_EXP_API int ctr_drbg_self_test( int verbose );

#endif /* SELF_TEST */

/* Internal functions (do not call directly) */
int ctr_drbg_seed_entropy_len( ctr_drbg_context *,
                               int (*)(void *, unsigned char *, uint32_t), void *,
