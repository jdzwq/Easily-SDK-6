...
typedef struct hmac_drbg_context
{
	...
	* but is implied by the HMAC context */
	...
	unsigned char V[MD_MAX_SIZE];  /*!< V in the spec          */
	int reseed_counter;                     /*!< reseed counter         */

	/* Administrative state */
	uint32_t entropy_len;         /*!< entropy bytes grabbed on each (re)seed */
	int prediction_resistance;  /*!< enable prediction resistance (Automatic
								reseed before every random generation) */
	int reseed_interval;        /*!< reseed interval   */

	/* Callbacks */
	int(*f_entropy)(void *, unsigned char *, uint32_t); /*!< entropy function */
 ...
 */
OEM_EXP_API void hmac_drbg_init(hmac_drbg_context *ctx);
 ...
 */
OEM_EXP_API int hmac_drbg_seed(hmac_drbg_context *ctx,
                    md_type_t md_type,
 ...
 *                      memory to allocate context data.
 */
OEM_EXP_API int hmac_drbg_seed_buf(hmac_drbg_context *ctx,
                        md_type_t md_type,
 ...
 */
OEM_EXP_API void hmac_drbg_set_prediction_resistance(hmac_drbg_context *ctx,
                                          int resistance );
 ...
 */
OEM_EXP_API void hmac_drbg_set_entropy_len(hmac_drbg_context *ctx,
                                uint32_t len );
 ...
 */
OEM_EXP_API void hmac_drbg_set_reseed_interval(hmac_drbg_context *ctx,
                                    int interval );
 ...
 *                      hash calculation.
 */
OEM_EXP_API int hmac_drbg_update(hmac_drbg_context *ctx,
 ...
 */
OEM_EXP_API int hmac_drbg_reseed(hmac_drbg_context *ctx,
 ...
 */
OEM_EXP_API int hmac_drbg_random_with_add(void *p_rng,
 ...
 */
OEM_EXP_API int hmac_drbg_random(void *p_rng, unsigned char *output, uint32_t out_len);
 ...
 */
OEM_EXP_API void hmac_drbg_free(hmac_drbg_context *ctx);
 ...
 */
OEM_EXP_API int hmac_drbg_self_test( int verbose );
