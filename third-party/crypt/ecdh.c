...
*      } ServerECDHParams;
*/
int ecdh_make_params(ecdh_context *ctx, uint32_t *olen,
	unsigned char *buf, uint32_t blen,
	int(*f_rng)(void *, unsigned char *, uint32_t),
	void *p_rng)
{
	int ret;
	uint32_t grp_len, pt_len;
...
*/
int ecdh_make_public(ecdh_context *ctx, uint32_t *olen,
	unsigned char *buf, uint32_t blen,
	int(*f_rng)(void *, unsigned char *, uint32_t),
	void *p_rng)
{
...
int ecdh_make_public_tls13(ecdh_context *ctx, uint32_t *olen,
	unsigned char *buf, uint32_t blen,
	int(*f_rng)(void *, unsigned char *, uint32_t),
	void *p_rng)
{
...
*/
int ecdh_calc_secret(ecdh_context *ctx, uint32_t *olen,
	unsigned char *buf, uint32_t blen,
	int(*f_rng)(void *, unsigned char *, uint32_t),
	void *p_rng)
{
...
int ecdh_test(int verbose)
{
	...
	unsigned char buf_cli[256] = { 0 };
	unsigned char buf_srv[256] = { 0 };
	unsigned char prm_cli[256] = { 0 };
	unsigned char prm_srv[256] = { 0 };
	...
	if (memcmp(prm_cli, prm_srv, len_cli) != 0)
