	...
	unsigned char *output)
{
	...
	if (output > input && (uint32_t)(output - input) < length)
	{
		return (-1);
	}
...
static const uint32_t iv_len[MAX_TESTS] =
{ 12, 12, 12, 12, 8, 60 };
...
static const uint32_t add_len[MAX_TESTS] =
{ 0, 0, 0, 20, 20, 20 };
...
static const uint32_t pt_len[MAX_TESTS] =
{ 0, 16, 64, 60, 60, 60 };
