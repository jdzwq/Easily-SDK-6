...
extern "C" {
	...
	*          MD layer.
	*/
	OEM_EXP_API int hkdf(const md_info_t *md, const unsigned char *salt,
	...
	*          MD layer.
	*/
	OEM_EXP_API int hkdf_extract(const md_info_t *md,
