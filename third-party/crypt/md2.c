...
*/
int md2(const unsigned char *input,
	uint32_t ilen,
	unsigned char output[16])
{
	int ret;
...
*/
int md2_hmac_starts(md2_context *ctx, const unsigned char *key, uint32_t keylen)
{
	int i;
...
*/
int md2_hmac_update(md2_context *ctx, const unsigned char *input, uint32_t ilen)
{
...
*/
int md2_hmac_finish(md2_context *ctx, unsigned char output[16])
{
...
*/
int md2_hmac(const unsigned char *key, uint32_t keylen, const unsigned char *input, uint32_t ilen,
	unsigned char output[16])
{
	md2_context ctx;
...
static const uint32_t md2_test_strlen[7] =
{
	0, 1, 3, 14, 26, 62, 80
};
