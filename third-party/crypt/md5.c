...
*/
int md5(const unsigned char *input,
	uint32_t ilen,
	unsigned char output[16])
{
	int ret;
...
*/
int md5_hmac_starts(md5_context *ctx, const unsigned char *key, uint32_t keylen)
{
	int i;
...
*/
int md5_hmac_update(md5_context *ctx, const unsigned char *input, uint32_t ilen)
{
...
*/
int md5_hmac_finish(md5_context *ctx, unsigned char output[16])
{
...
*/
int md5_hmac(const unsigned char *key, uint32_t keylen, const unsigned char *input, uint32_t ilen,
	unsigned char output[16])
{
	md5_context ctx;
...
static const uint32_t md5_test_buflen[7] =
{
	0, 1, 3, 14, 26, 62, 80
};
