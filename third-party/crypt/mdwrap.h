...
*/
OEM_EXP_API const md_info_t* md_info_from_type(md_type_t md);
 ...
 *                  failure.
 */
OEM_EXP_API int md_starts(const md_info_t *md_info, void *ctx);
 ...
 *                  failure.
 */
OEM_EXP_API int md_update(const md_info_t *md_info, void *ctx, const unsigned char *input, uint32_t ilen);
 ...
 *                  failure.
 */
OEM_EXP_API int md_finish(const md_info_t *md_info, void *ctx, unsigned char *output);
 ...
 *                 failure.
 */
OEM_EXP_API int md(const md_info_t *md_info, const unsigned char *input, uint32_t ilen,
 ...
 *                 failure.
 */
OEM_EXP_API int md_hmac(const md_info_t *md_info, const unsigned char *key, uint32_t keylen,
 ...
 *                  failure.
 */
OEM_EXP_API int md_hmac_starts(const md_info_t *md_info, void *ctx, const unsigned char *key,
                    uint32_t keylen );
 ...
 *                  failure.
 */
OEM_EXP_API int md_hmac_update(const md_info_t *md_info, void *ctx, const unsigned char *input,
                    uint32_t ilen );
 ...
 *                  failure.
 */
OEM_EXP_API int md_hmac_finish(const md_info_t *md_info, void *ctx, unsigned char *output);
 ...
 *                  failure.
 */
OEM_EXP_API int md_hmac_reset(const md_info_t *md_info, void *ctx);

OEM_EXP_API void* md_alloc(const md_info_t *md_info);

OEM_EXP_API void md_free(const md_info_t *md_info, void* ctx);
