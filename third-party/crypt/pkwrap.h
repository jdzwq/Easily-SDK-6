...
typedef struct _pk_info_t
{
	...
	uint32_t(*get_bitlen)(const void *);
}pk_info_t;
 ...
 */
OEM_EXP_API const pk_info_t* pk_info_from_type(pk_type_t pk);
 ...
 */
OEM_EXP_API int pk_verify( pk_type_t pktype, void *pk_ctx, md_type_t md_alg,
