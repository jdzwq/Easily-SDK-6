...
{
	int ver;                    /*!<  Always 0.*/
	uint32_t len;                 /*!<  The size of \p N in Bytes. */
...
*
*/
OEM_EXP_API int rsa_deduce_primes(mpi const *N, mpi const *E,
mpi const *D,
mpi *P, mpi *Q);
...
*
*/
OEM_EXP_API int rsa_deduce_private_exponent(mpi const *P,
	mpi const *Q,
	mpi const *E,
	mpi *D);
...
*
*/
OEM_EXP_API int rsa_deduce_crt(const mpi *P, const mpi *Q,
	const mpi *D, mpi *DP,
	mpi *DQ, mpi *QP);
...
*/
OEM_EXP_API int rsa_validate_params(const mpi *N, const mpi *P,
...
*/
OEM_EXP_API int rsa_validate_crt(const mpi *P, const mpi *Q,
 ...
 *                 otherwise.
 */
OEM_EXP_API void rsa_init(rsa_context *ctx,
                       int padding,
                       int hash_id );
 ...
 */
OEM_EXP_API int rsa_import(rsa_context *ctx,
                        const mpi *N,
 ...
 * \return         A non-zero error code on failure.
 */
OEM_EXP_API int rsa_import_raw(rsa_context *ctx,
                            unsigned char const *N, uint32_t N_len,
                            unsigned char const *P, uint32_t P_len,
                            unsigned char const *Q, uint32_t Q_len,
 ...
 *
 */
OEM_EXP_API int rsa_complete(rsa_context *ctx);
 ...
 *                 stores the key OEM_EXP_APIally, and either cannot or should
 ...
 *
 */
OEM_EXP_API int rsa_export(const rsa_context *ctx,
                        mpi *N, mpi *P, mpi *Q,
                        mpi *D, mpi *E );
 ...
 * \return         A non-zero return code on any other failure.
 */
OEM_EXP_API int rsa_export_raw(const rsa_context *ctx,
                            unsigned char *N, uint32_t N_len,
                            unsigned char *P, uint32_t P_len,
                            unsigned char *Q, uint32_t Q_len,
                            unsigned char *D, uint32_t D_len,
                            unsigned char *E, uint32_t E_len );
 ...
 *
 */
OEM_EXP_API int rsa_export_crt(const rsa_context *ctx,
 ...
 */
OEM_EXP_API void rsa_set_padding(rsa_context *ctx, int padding,
                              int hash_id );
 ...
 *
 */
OEM_EXP_API uint32_t rsa_get_len(const rsa_context *ctx);
 ...
 */
OEM_EXP_API int rsa_gen_key(rsa_context *ctx,
                         int (*f_rng)(void *, unsigned char *, uint32_t),
                         void *p_rng,
                         uint32_t nbits, int exponent );
 ...
 *
 */
OEM_EXP_API int rsa_check_pubkey(const rsa_context *ctx);
 ...
 * \return     An \c ERR_RSA_XXX error code on failure.
 */
OEM_EXP_API int rsa_check_privkey(const rsa_context *ctx);
 ...
 * \return         An \c ERR_RSA_XXX error code on failure.
 */
OEM_EXP_API int rsa_check_pub_priv(const rsa_context *pub,
 ...
 * \return         An \c ERR_RSA_XXX error code on failure.
 */
OEM_EXP_API int rsa_public(rsa_context *ctx,
 ...
 *
 */
OEM_EXP_API int rsa_private(rsa_context *ctx,
                 int (*f_rng)(void *, unsigned char *, uint32_t),
                 void *p_rng,
                 const unsigned char *input,
                 unsigned char *output );
 ...
 * \return         An \c ERR_RSA_XXX error code on failure.
 */
OEM_EXP_API int rsa_pkcs1_encrypt(rsa_context *ctx,
                       int (*f_rng)(void *, unsigned char *, uint32_t),
                       void *p_rng,
 ...
 * \return         An \c ERR_RSA_XXX error code on failure.
 */
OEM_EXP_API int rsa_rsaes_pkcs1_v15_encrypt(rsa_context *ctx,
                                 int (*f_rng)(void *, unsigned char *, uint32_t),
                                 void *p_rng,
                                 int mode, uint32_t ilen,
                                 const unsigned char *input,
 ...
 * \return           An \c ERR_RSA_XXX error code on failure.
 */
OEM_EXP_API int rsa_rsaes_oaep_encrypt(rsa_context *ctx,
                            int (*f_rng)(void *, unsigned char *, uint32_t),
                            void *p_rng,
                            int mode,
                            const unsigned char *label, uint32_t label_len,
                            uint32_t ilen,
                            const unsigned char *input,
                            unsigned char *output );
 ...
 * \return         An \c ERR_RSA_XXX error code on failure.
 */
OEM_EXP_API int rsa_pkcs1_decrypt(rsa_context *ctx,
                       int (*f_rng)(void *, unsigned char *, uint32_t),
                       void *p_rng,
 ...
 *
 */
OEM_EXP_API int rsa_rsaes_pkcs1_v15_decrypt(rsa_context *ctx,
                                 int (*f_rng)(void *, unsigned char *, uint32_t),
                                 void *p_rng,
                                 int mode, uint32_t *olen,
                                 const unsigned char *input,
 ...
 * \return         An \c ERR_RSA_XXX error code on failure.
 */
OEM_EXP_API int rsa_rsaes_oaep_decrypt(rsa_context *ctx,
                            int (*f_rng)(void *, unsigned char *, uint32_t),
                            void *p_rng,
                            int mode,
                            const unsigned char *label, uint32_t label_len,
 ...
 * \return         An \c ERR_RSA_XXX error code on failure.
 */
OEM_EXP_API int rsa_pkcs1_sign(rsa_context *ctx,
                    int (*f_rng)(void *, unsigned char *, uint32_t),
                    void *p_rng,
                    int mode,
                    int hashalg,
 ...
 * \return         An \c ERR_RSA_XXX error code on failure.
 */
OEM_EXP_API int rsa_rsassa_pkcs1_v15_sign(rsa_context *ctx,
                               int (*f_rng)(void *, unsigned char *, uint32_t),
                               void *p_rng,
                               int mode,
                               int hashalg,
 ...
 * \return         An \c ERR_RSA_XXX error code on failure.
 */
OEM_EXP_API int rsa_rsassa_pss_sign(rsa_context *ctx,
                         int (*f_rng)(void *, unsigned char *, uint32_t),
                         void *p_rng,
                         int mode,
                         int hashalg,
 ...
 * \return         An \c ERR_RSA_XXX error code on failure.
 */
OEM_EXP_API int rsa_pkcs1_verify(rsa_context *ctx,
                      int (*f_rng)(void *, unsigned char *, uint32_t),
                      void *p_rng,
                      int mode,
                      int hashalg,
 ...
 * \return         An \c ERR_RSA_XXX error code on failure.
 */
OEM_EXP_API int rsa_rsassa_pkcs1_v15_verify(rsa_context *ctx,
                                 int (*f_rng)(void *, unsigned char *, uint32_t),
                                 void *p_rng,
                                 int mode,
                                 int hashalg,
 ...
 * \return         An \c ERR_RSA_XXX error code on failure.
 */
OEM_EXP_API int rsa_rsassa_pss_verify(rsa_context *ctx,
                           int (*f_rng)(void *, unsigned char *, uint32_t),
                           void *p_rng,
                           int mode,
                           int hashalg,
 ...
 * \return         An \c ERR_RSA_XXX error code on failure.
 */
OEM_EXP_API int rsa_rsassa_pss_verify_ext(rsa_context *ctx,
                               int (*f_rng)(void *, unsigned char *, uint32_t),
                               void *p_rng,
                               int mode,
                               int hashalg,
 ...
 */
OEM_EXP_API int rsa_copy(rsa_context *dst, const rsa_context *src);
 ...
 */
OEM_EXP_API void rsa_free(rsa_context *ctx);

OEM_EXP_API int rsa_export_pubkey(rsa_context *ctx, unsigned char *data, int* olen, int ne);

OEM_EXP_API int rsa_pubkey_size(rsa_context* ctx);

OEM_EXP_API int rsa_import_pubkey(rsa_context *ctx, unsigned char **p, unsigned char* end, int ne);

OEM_EXP_API int rsa_parse_key(rsa_context *rsa, unsigned char *buf, int buflen, unsigned char *pwd, int pwdlen);
 ...
 */
OEM_EXP_API int rsa_self_test( int verbose );

OEM_EXP_API int rsa_test_parse(int verbose);
