	...
	const sha1_context *src)
{
	...
	memcpy((void*)dst, (void*)src, sizeof(sha1_context));
}
...
*/
int sha1_hmac_starts(sha1_context *ctx, const unsigned char *key, uint32_t keylen)
{
	int i;
...
*/
int sha1_hmac_update(sha1_context *ctx, const unsigned char *input, uint32_t ilen)
{
...
*/
int sha1_hmac_finish(sha1_context *ctx, unsigned char output[20])
{
...
*/
int sha1_hmac(const unsigned char *key, uint32_t keylen, const unsigned char *input, uint32_t ilen,
	unsigned char output[20])
{
	sha1_context ctx;
...
static const uint32_t sha1_test_buflen[3] =
{
	3, 56, 1000
};
