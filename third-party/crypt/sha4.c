	...
	const sha512_context *src)
{
	...
	memcpy((void*)dst, (void*)src, sizeof(sha512_context));
}
	...
	const unsigned char data[128])
{
	...
	assert(ctx != NULL);
	assert((const unsigned char *)data != NULL);
...
*/
int sha512_hmac_starts(sha512_context *ctx, const unsigned char *key, uint32_t keylen,
	int is384)
{
	int i;
...
*/
int sha512_hmac_update(sha512_context *ctx, const unsigned char *input, uint32_t ilen)
{
...
*/
int sha512_hmac_finish(sha512_context *ctx, unsigned char output[64])
{
	int is384, hlen;
...
*/
int sha512_hmac(const unsigned char *key, uint32_t keylen,
...
static const uint32_t sha512_test_buflen[3] =
{
	3, 112, 1000
};
...
int sha512_self_test(int verbose)
{
	...
	buf = malloc(1024 * sizeof(unsigned char));
	if (NULL == buf)
	{
		if (verbose != 0)
