 ...
 *
 */
OEM_EXP_API void sm3_init(sm3_context *ctx);
 ...
 *
 */
OEM_EXP_API void sm3_free(sm3_context *ctx);
 ...
 *
 */
OEM_EXP_API void sm3_clone(sm3_context *dst,
 ...
 *
 */
OEM_EXP_API int sm3_starts(sm3_context *ctx);
 ...
 * \return         A negative error code on failure.
 */
OEM_EXP_API int sm3_update(sm3_context *ctx,
 ...
 * \return         A negative error code on failure.
 */
OEM_EXP_API int sm3_finish(sm3_context *ctx,
 ...
 *
 */
OEM_EXP_API int internal_sm3_process(sm3_context *ctx,
 ...
 *
 */
OEM_EXP_API int sm3(const unsigned char *input,
                      uint32_t ilen,
                      unsigned char output[32] );
 ...
 *                  failure.
 */
OEM_EXP_API int sm3_hmac_starts(sm3_context *ctx, const unsigned char *key,
                    uint32_t keylen );
 ...
 *                  failure.
 */
OEM_EXP_API int sm3_hmac_update(sm3_context *ctx, const unsigned char *input,
                    uint32_t ilen );
 ...
 *                  failure.
 */
OEM_EXP_API int sm3_hmac_finish(sm3_context *ctx, unsigned char output[32]);
 ...
 *                  failure.
 */
OEM_EXP_API int sm3_hmac_reset(sm3_context *ctx);
 ...
 *                 failure.
 */
OEM_EXP_API int sm3_hmac(const unsigned char *key, uint32_t keylen,
 ...
 *
 */
OEM_EXP_API int sm3_self_test( int verbose );
