...
*/
OEM_EXP_API int x509_crl_parse_der(x509_crl *chain,
...
* \return         0 if successful, or a specific X509 or PEM error code
*/
OEM_EXP_API int x509_crl_parse(x509_crl *chain, const unsigned char *buf, uint32_t buflen);
...
*/
OEM_EXP_API int x509_crl_info(char *buf, uint32_t size, const char *prefix,
	const x509_crl *crl);
...
*/
OEM_EXP_API void x509_crl_init(x509_crl *crl);
...
*/
OEM_EXP_API void x509_crl_free(x509_crl *crl);
