 ...
 */
//OEM_EXP_API const x509_crt_profile x509_crt_profile_default;

/**
 * Expected next default profile. Recommended for new deployments.
 * Currently targets a 128-bit security level, except for RSA-2048.
 */
//OEM_EXP_API const x509_crt_profile x509_crt_profile_next;

/**
 * NSA Suite B profile.
 */
//OEM_EXP_API const x509_crt_profile x509_crt_profile_suiteb;
 ...
 */
OEM_EXP_API int x509_crt_parse_der(x509_crt *chain, const unsigned char *buf,
                        uint32_t buflen );
 ...
 *
 */
OEM_EXP_API int x509_crt_parse(x509_crt *chain, const unsigned char *buf, uint32_t buflen);
 ...
 */
OEM_EXP_API int x509_crt_info(char *buf, uint32_t size, const char *prefix,
                   const x509_crt *crt );
 ...
 *                 terminated nul byte), or a negative error code.
 */
OEM_EXP_API int x509_crt_verify_info(char *buf, uint32_t size, const char *prefix,
                          uint32_t flags );
 ...
 */
OEM_EXP_API int x509_crt_verify(x509_crt *crt,
                    x509_crt *trust_ca,
                    x509_crl *ca_crl,
                     const char *cn, uint32_t *flags,
                     int (*f_vrfy)(void *,x509_crt *, int, uint32_t *),
                     void *p_vrfy );
 ...
 */
OEM_EXP_API int x509_crt_verify_with_profile(x509_crt *crt,
                    x509_crt *trust_ca,
                    x509_crl *ca_crl,
 ...
 */
OEM_EXP_API int x509_crt_verify_restartable(x509_crt *crt,
                    x509_crt *trust_ca,
                    x509_crl *ca_crl,
                     const x509_crt_profile *profile,
                     const char *cn, uint32_t *flags,
 ...
 */
OEM_EXP_API int x509_crt_check_key_usage(const x509_crt *crt,
                                      unsigned int usage );
 ...
 */
OEM_EXP_API int x509_crt_check_extended_key_usage(const x509_crt *crt,
 ...
 *
 */
OEM_EXP_API int x509_crt_is_revoked(const x509_crt *crt, const x509_crl *crl);
 ...
 */
OEM_EXP_API void x509_crt_init(x509_crt *crt);
 ...
 */
OEM_EXP_API void x509_crt_free(x509_crt *crt);
 ...
 */
OEM_EXP_API void x509write_crt_init(x509write_cert *ctx);
 ...
 *                                  X509_CRT_VERSION_3)
 */
OEM_EXP_API void x509write_crt_set_version(x509write_cert *ctx, int version);
 ...
 */
OEM_EXP_API int x509write_crt_set_serial(x509write_cert *ctx, const mpi *serial);
 ...
 */
OEM_EXP_API int x509write_crt_set_validity(x509write_cert *ctx, const char *not_before,
 ...
 *                  a specific error code
 */
OEM_EXP_API int x509write_crt_set_issuer_name(x509write_cert *ctx,
 ...
 *                  a specific error code
 */
OEM_EXP_API int x509write_crt_set_subject_name(x509write_cert *ctx,
 ...
 */
OEM_EXP_API void x509write_crt_set_subject_key(x509write_cert *ctx, pk_type_t pktype, void *pk_ctx);
 ...
 */
OEM_EXP_API void x509write_crt_set_issuer_key(x509write_cert *ctx, pk_type_t pktype, void *pk_ctx);
 ...
 */
OEM_EXP_API void x509write_crt_set_md_alg(x509write_cert *ctx, md_type_t md_alg);
 ...
 */
OEM_EXP_API int x509write_crt_set_extension(x509write_cert *ctx,
 ...
 * \return          0 if successful, or a ERR_X509_ALLOC_FAILED
 */
OEM_EXP_API int x509write_crt_set_basic_constraints(x509write_cert *ctx,
 ...
 * \return          0 if successful, or a ERR_X509_ALLOC_FAILED
 */
OEM_EXP_API int x509write_crt_set_subject_key_identifier(x509write_cert *ctx);
 ...
 * \return          0 if successful, or a ERR_X509_ALLOC_FAILED
 */
OEM_EXP_API int x509write_crt_set_authority_key_identifier(x509write_cert *ctx);
 ...
 */
OEM_EXP_API int x509write_crt_set_key_usage(x509write_cert *ctx,
 ...
 * \return          0 if successful, or ERR_X509_ALLOC_FAILED
 */
OEM_EXP_API int x509write_crt_set_ns_cert_type(x509write_cert *ctx,
 ...
 */
OEM_EXP_API void x509write_crt_free(x509write_cert *ctx);
 ...
 */
OEM_EXP_API int x509write_crt_der(x509write_cert *ctx, unsigned char *buf, uint32_t size,
 ...
 *                  ECDSA signatures always require a non-NULL f_rng.
 */
OEM_EXP_API int x509write_crt_pem(x509write_cert *ctx, unsigned char *buf, uint32_t size,
                       int (*f_rng)(void *, unsigned char *, uint32_t),
                       void *p_rng );
