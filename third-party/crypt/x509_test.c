...
static char TEST_CA_CRT_EC_PEM[] = \
"-----BEGIN CERTIFICATE-----\r\n"                                      \
...
static unsigned char TEST_CA_CRT_EC_DER[] = { \
...
static unsigned char TEST_CA_KEY_EC_DER[] = { \
...
static char TEST_CA_CRT_RSA_SHA256_PEM[] = \
"-----BEGIN CERTIFICATE-----\r\n"                                      \
...
static unsigned char TEST_CA_CRT_RSA_SHA256_DER[] = { \
...
static char TEST_CA_CRT_RSA_SHA1_PEM[] = \
"-----BEGIN CERTIFICATE-----\r\n"                                      \
...
static unsigned char TEST_CA_CRT_RSA_SHA1_DER[] = { \
0x30, 0x82, 0x03, 0x41, 0x30, 0x82, 0x02, 0x29, 0xa0, 0x03, 0x02, 0x01, \
0x02, 0x02, 0x01, 0x03, 0x30, 0x0d, 0x06, 0x09, 0x2a, 0x86, 0x48, 0x86, \
...
static unsigned char TEST_CA_KEY_RSA_DER[] = {                                                \
...
static char TEST_SRV_CRT_EC_PEM[] = \
"-----BEGIN CERTIFICATE-----\r\n"                                      \
...
static unsigned char TEST_SRV_CRT_EC_DER[] = { \
...
static unsigned char TEST_SRV_KEY_EC_DER[] = { \
...
static char TEST_SRV_CRT_RSA_SHA256_PEM[] = \
"-----BEGIN CERTIFICATE-----\r\n"                                      \
...
static unsigned char TEST_SRV_CRT_RSA_SHA256_DER[] = { \
...
static char TEST_SRV_CRT_RSA_SHA1_PEM[] = \
"-----BEGIN CERTIFICATE-----\r\n"                                      \
...
static unsigned char TEST_SRV_CRT_RSA_SHA1_DER[] = { \
0x30, 0x82, 0x03, 0x37, 0x30, 0x82, 0x02, 0x1f, 0xa0, 0x03, 0x02, 0x01, \
0x02, 0x02, 0x01, 0x02, 0x30, 0x0d, 0x06, 0x09, 0x2a, 0x86, 0x48, 0x86, \
0xf7, 0x0d, 0x01, 0x01, 0x05, 0x05, 0x00, 0x30, 0x3b, 0x31, 0x0b, 0x30, \
0x09, 0x06, 0x03, 0x55, 0x04, 0x06, 0x13, 0x02, 0x4e, 0x4c, 0x31, 0x11, \
...
static unsigned char TEST_SRV_KEY_RSA_DER[] = {                                               \
    0x30, 0x82, 0x04, 0xa4, 0x02, 0x01, 0x00, 0x02, 0x82, 0x01, 0x01, 0x00,  \
...
static char TEST_CLI_CRT_EC_PEM[] = \
"-----BEGIN CERTIFICATE-----\r\n"                                      \
...
static unsigned char TEST_CLI_CRT_EC_DER[] = { \
...
static unsigned char TEST_CLI_KEY_EC_DER[] = { \
...
static char TEST_CLI_CRT_RSA_PEM[] = \
"-----BEGIN CERTIFICATE-----\r\n"                                      \
...
static unsigned char TEST_CLI_CRT_RSA_DER[] = { \
...
static unsigned char TEST_CLI_KEY_RSA_DER[] = {                                               \
    0x30, 0x82, 0x04, 0xa4, 0x02, 0x01, 0x00, 0x02, 0x82, 0x01, 0x01, 0x00,  \
...
int x509_self_test(int verbose)
{
	...
	ret = x509_crt_parse(&clicert, (const unsigned char *)TEST_CLI_CRT_RSA_PEM,
		strlen(TEST_CLI_CRT_RSA_PEM));
	if (ret != 0)
	{
		if (verbose != 0)
			printf("failed\n");
	...
	ret = x509_crt_parse(&cacert, (const unsigned char *)TEST_CA_CRT_RSA_SHA1_PEM,
		strlen(TEST_CA_CRT_RSA_SHA1_PEM));
	if (ret != 0)
	{
		if (verbose != 0)
			printf("failed\n");
