...
#define SETSQLPANELDELTA(ph,ptd)	widget_set_user_delta(ph,(vword_t)ptd)

#define SQLPANEL_ACCEL_COUNT	5
accel_table_t	SQLPANEL_ACCEL[SQLPANEL_ACCEL_COUNT] = {
...
void	SQLPanel_Switch(widget_t widget);

bool_t	SQLPanel_SaveFile(widget_t widget, const tchar_t* szFile);
bool_t	SQLPanel_OpenFile(widget_t widget, const tchar_t* szFile);
...
/***************************************************************************************************************/
void SQLPanel_OnSelectAll(widget_t widget)
{
	SQLPanelDelta* pdt = GETSQLPANELDELTA(widget);
...
void SQLPanel_OnCopy(widget_t widget)
{
	SQLPanelDelta* pdt = GETSQLPANELDELTA(widget);
...
void SQLPanel_OnCut(widget_t widget)
{
	SQLPanelDelta* pdt = GETSQLPANELDELTA(widget);
...
void SQLPanel_OnPaste(widget_t widget)
{
	SQLPanelDelta* pdt = GETSQLPANELDELTA(widget);
...
void SQLPanel_OnRedo(widget_t widget)
{
	SQLPanelDelta* pdt = GETSQLPANELDELTA(widget);

}

void SQLPanel_OnUndo(widget_t widget)
{
	SQLPanelDelta* pdt = GETSQLPANELDELTA(widget);
...
void SQLPanel_OnSave(widget_t widget)
{
	SQLPanelDelta* pdt = GETSQLPANELDELTA(widget);
...
void SQLPanel_OnSaveAs(widget_t widget)
{
	SQLPanelDelta* pdt = GETSQLPANELDELTA(widget);
...
void SQLPanel_OnSheet(widget_t widget)
{
	SQLPanelDelta* pdt = GETSQLPANELDELTA(widget);
...
void SQLPanel_OnExport(widget_t widget)
{
	SQLPanelDelta* pdt = GETSQLPANELDELTA(widget);
...
void SQLPanel_OnExecute(widget_t widget)
{
	SQLPanelDelta* pdt = GETSQLPANELDELTA(widget);
...
void SQLPanel_OnSelect(widget_t widget)
{
	SQLPanelDelta* pdt = GETSQLPANELDELTA(widget);
...
void SQLPanel_OnPrint(widget_t widget)
{
	SQLPanelDelta* pdt = GETSQLPANELDELTA(widget);
}

void SQLPanel_OnPreview(widget_t widget)
{
	SQLPanelDelta* pdt = GETSQLPANELDELTA(widget);
...
int SQLPanel_OnCreate(widget_t widget, void* data)
{
	...
	widget_set_accel(widget, SQLPANEL_ACCEL, SQLPANEL_ACCEL_COUNT);
...
void SQLPanel_OnDestroy(widget_t widget)
{
	SQLPanelDelta* pdt = GETSQLPANELDELTA(widget);
...
int SQLPanel_OnClose(widget_t widget)
{
	SQLPanelDelta* pdt = GETSQLPANELDELTA(widget);
...
void SQLPanel_OnSetFocus(widget_t widget, widget_t hOrg)
{
	SQLPanelDelta* pdt = GETSQLPANELDELTA(widget);
...
void SQLPanel_OnShow(widget_t widget, bool_t bShow)
{
	SQLPanelDelta* pdt = GETSQLPANELDELTA(widget);
...
void SQLPanel_OnCommandFind(widget_t widget, str_find_t* pfd)
{
	SQLPanelDelta* pdt = GETSQLPANELDELTA(widget);
...
void SQLPanel_OnParentCommand(widget_t widget, int code, vword_t data)
{
	SQLPanelDelta* pdt = GETSQLPANELDELTA(widget);
...
void SQLPanel_OnMenuCommand(widget_t widget, int code, int cid, vword_t data)
{
	SQLPanelDelta* pdt = GETSQLPANELDELTA(widget);
	void* pv = NULL;
...
void SQLPanel_OnNotice(widget_t widget, LPNOTICE phdr)
{
	SQLPanelDelta* pdt = GETSQLPANELDELTA(widget);

	if (phdr->user == IDC_SQLPANEL_MEMO)
	{
...
/*********************************************************************************************************/
widget_t SQLPanel_Create(const tchar_t* wname, dword_t wstyle, const xrect_t* pxr, const tchar_t* fpath)
{
	if_dispatch_t ev = { 0 };
