...
# 1. nmake /f xdb_oci.mk test --if need to creating some directory or file-list
# 2. nmake /f xdb_oci.mk clean --if no longer debuging
# 3. nmake /f xdb_oci.mk
# 4. nmake /f xdb_oci.mk install
#-----------------------------------------------------------------------------
...
INC_oci = "E:/oracle/instantclient_19c/sdk/include"
LIB_oci = "E:/oracle/instantclient_19c/sdk/lib/msvc"
...
test:
 	...
 	for %i in ($(SRC_PATH)/oci/*.c) do @echo $(OBJ_PATH)/%i \>>$(MODULE).txt
