...
# making order:
# 1. nmake /f xdb_odbc.so.mk test --if need to creating some directory or file-list
# 2. nmake /f xdb_odbc.so.mk clean --if no longer debuging
# 3. nmake /f xdb_odbc.so.mk
# 4. nmake /f xdb_odbc.so.mk install
#-----------------------------------------------------------------------------
!if EXIST("xdb_odbc.txt")
