...
# 1. nmake /f xdb_stub.mk test --if need to creating some directory or file-list
# 2. nmake /f xdb_stub.mk clean --if no longer debuging
# 3. nmake /f xdb_stub.mk
# 4. nmake /f xdb_stub.mk install
#-----------------------------------------------------------------------------
...
test:
 	...
 	for %i in ($(SRC_PATH)/stub/*.c) do @echo $(OBJ_PATH)/%i \>>$(MODULE).txt
