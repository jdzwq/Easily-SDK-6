...
static void _horzbox_bar_rect(widget_t widget, xrect_t* pxr)
{
...
static int _horzbox_hint_bar(widget_t widget, const xpoint_t* pxp)
{
	horzbox_delta_t* ptd = GETHORZBOXDELTA(widget);
	xrect_t xr, xr2;
	viewbox_t vb;
...
/*********************************************************************************/
int hand_horzbox_create(widget_t widget, void* data)
{
	horzbox_delta_t* ptd;
...
void hand_horzbox_destroy(widget_t widget)
{
	horzbox_delta_t* ptd = GETHORZBOXDELTA(widget);
...
void hand_horzbox_lbutton_down(widget_t widget, const xpoint_t* pxp)
{
	horzbox_delta_t* ptd = GETHORZBOXDELTA(widget);
	int delta; 
...
void hand_horzbox_mouse_move(widget_t widget, dword_t dw, const xpoint_t* pxp)
{
	horzbox_delta_t* ptd = GETHORZBOXDELTA(widget);
	int delta;
...
void hand_horzbox_lbutton_up(widget_t widget, const xpoint_t* pxp)
{
	horzbox_delta_t* ptd = GETHORZBOXDELTA(widget);
...
void hand_horzbox_size(widget_t widget, int code, const xsize_t* prs)
{
	horzbox_delta_t* ptd = GETHORZBOXDELTA(widget);
...
void hand_horzbox_paint(widget_t widget, visual_t dc, const xrect_t* pxr)
{
	horzbox_delta_t* ptd = GETHORZBOXDELTA(widget);
	visual_t rdc;
	canvas_t canv;
...
/***************************************************************************************/
widget_t horzbox_create(widget_t widget, dword_t style, const xrect_t* pxr)
{
	if_dispatch_t ev = { 0 };
...
void horzbox_popup_size(widget_t widget, xsize_t* pxs)
{
	horzbox_delta_t* ptd = GETHORZBOXDELTA(widget);
...
void horzbox_set_target(widget_t widget, widget_t target)
{
	horzbox_delta_t* ptd = GETHORZBOXDELTA(widget);
...
widget_t show_horzbox(widget_t owner)
{
	widget_t wt;
	xrect_t xr = { 0 };
	xsize_t xs = { 0 };
