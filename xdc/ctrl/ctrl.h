/***********************************************************************
	...
	@devnote ’≈Œƒ»® 2021.01 - 2021.12	v6.0
***********************************************************************/
...
*/
EXP_API void tagctrl_set_focus_phrase(res_win_t widget, link_t_ptr ilk);
...
*/
EXP_API link_t_ptr tagctrl_get_focus_phrase(res_win_t widget);
...
@RETURN void: none.
*/
EXP_API void tagctrl_get_phrase_rect(res_win_t widget, link_t_ptr nlk, xrect_t* pxr);
...
@RETURN void: none.
*/
EXP_API void tagctrl_delete_phrase(res_win_t widget, link_t_ptr nlk);
...
@RETURN void: none.
*/
EXP_API void tagctrl_set_phrase_text(res_win_t widget, link_t_ptr nlk, const tchar_t* token, int len);
