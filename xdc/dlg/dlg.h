...
@RETURN widget_t: return the dialog resource handle.
*/
EXP_API widget_t msgdlg_create(const tchar_t* text, dword_t button, widget_t owner);
...
@RETURN void: none.
*/
EXP_API void msgdlg_popup_size(widget_t widget, xsize_t* pxs);
...
@RETURN widget_t: return the dialog resource handle.
*/
EXP_API widget_t inputdlg_create(const tchar_t* title, tchar_t* buf, int max, widget_t owner);
...
@RETURN void: none.
*/
EXP_API void inputdlg_popup_size(widget_t widget, xsize_t* pxs);
...
@RETURN widget_t: return the dialog resource handle.
*/
EXP_API widget_t properdlg_create(const tchar_t* title, link_t_ptr ptr, widget_t owner);
...
@RETURN void: none.
*/
EXP_API void properdlg_popup_size(widget_t widget, xsize_t* pxs);
...
@RETURN widget_t: return the dialog resource handle.
*/
EXP_API widget_t tabledlg_create(const tchar_t* title, link_t_ptr ptr, widget_t owner);
...
@RETURN void: none.
*/
EXP_API void tabledlg_popup_size(widget_t widget, xsize_t* pxs);
...
@RETURN widget_t: return the dialog resource handle.
*/
EXP_API widget_t listdlg_create(const tchar_t* title, link_t_ptr ptr, widget_t owner);
...
@RETURN void: none.
*/
EXP_API void listdlg_popup_size(widget_t widget, xsize_t* pxs);
...
@RETURN widget_t: return the dialog resource handle.
*/
EXP_API widget_t textdlg_create(const tchar_t* title, string_t var, widget_t owner);
...
@RETURN void: none.
*/
EXP_API void textdlg_popup_size(widget_t widget, xsize_t* pxs);
...
@RETURN widget_t: return the dialog resource handle.
*/
EXP_API widget_t griddlg_create(const tchar_t* title, link_t_ptr ptr, link_t_ptr* prow, widget_t owner);
...
@RETURN void: none.
*/
EXP_API void griddlg_popup_size(widget_t widget, xsize_t* pxs);
...
@RETURN widget_t: return the dialog resource handle.
*/
EXP_API widget_t annodlg_create(const tchar_t* title, string_t var, widget_t owner);
...
@RETURN widget_t: return the dialog resource handle.
*/
EXP_API widget_t previewdlg_create(const tchar_t* title, widget_t owner);
...
*/
EXP_API link_t_ptr previewdlg_get_arch(widget_t widget);
...
@RETURN void: none.
*/
EXP_API void previewdlg_redraw(widget_t widget);
...
@RETURN widget_t: return the dialog resource handle.
*/
EXP_API widget_t create_dialog(link_t_ptr ptr_dlg, widget_t owner);

EXP_API int sub_dialog_on_paint(widget_t widget, visual_t rdc, const xrect_t* prt, uid_t sid, vword_t delta);

EXP_API int sub_dialog_on_size(widget_t widget, int code, const xsize_t* pxs, uid_t sid, vword_t delta);
