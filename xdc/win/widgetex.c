...
void  widget_attach_menu(widget_t wt, link_t_ptr menu)
{
	widget_exten_t* pwt;
...
link_t_ptr  widget_get_menu(widget_t wt)
{
	widget_exten_t* pwt;
...
link_t_ptr  widget_detach_menu(widget_t wt)
{
	widget_exten_t* pwt;
	link_t_ptr menu;
...
link_t_ptr  widget_get_splitor(widget_t wt)
{
	widget_exten_t* pwt;
...
link_t_ptr  widget_detach_splitor(widget_t wt)
{
	widget_exten_t* pwt;
	link_t_ptr splitor;
	...
	pwt->splitor.widget = (widget_t)0;

	return splitor;
}

void widget_layout_splitor(widget_t wt)
{
	widget_exten_t* pwt;
	xrect_t xr;
...
bool_t widget_dock(widget_t wt, dword_t style, int cx, int cy)
{
	widget_exten_t* pwt;
	int i;
...
void widget_undock(widget_t wt, dword_t style)
{
	widget_exten_t* pwt;
	int i;
...
void widget_get_dock_rect(widget_t wt, dword_t style, xrect_t* pxr)
{
	widget_exten_t* pwt;
...
void widget_calc_scroll(widget_t wt, bool_t bHorz, scroll_t* psl)
{
	widget_exten_t* pwt;
...
void widget_reset_scroll(widget_t wt, bool_t horz)
{
	widget_exten_t* pwt;
	scroll_t sc = { 0 };
...
void widget_reset_paging(widget_t wt, int ww, int wh, int vw, int vh, int lw, int lh)
{
	...
	{
		cx = mm_to_pt(canv, DEF_PAGE_FEED, 1) - mm_to_pt(canv, 0, 1);
		cy = mm_to_pt(canv, DEF_PAGE_FEED, 0) - mm_to_pt(canv, 0, 0);
	}
	else
	{
		cx = 0;
	...
	if (widget_can_paging(wt))
	{
		min_cx = pt_to_mm(canv, pwt->cb.x, 1) - pt_to_mm(canv, 0, 1);
		min_cy = pt_to_mm(canv, pwt->cb.y, 0) - pt_to_mm(canv, 0, 0);
...
void widget_get_view_rect(widget_t wt, viewbox_t* pbox)
{
	widget_exten_t* pwt;
...
void widget_get_view_size(widget_t wt, xsize_t* pxs)
{
	widget_exten_t* pwt;
...
void widget_get_canv_rect(widget_t wt, canvbox_t* pbox)
{
	canvas_t canv;
	xrect_t xr;
...
void widget_get_canv_size(widget_t wt, xsize_t* pps)
{
	canvas_t canv;
	...
	size_pt_to_mm(canv, pps);
}

void widget_ensure_visible(widget_t wt, const xrect_t* pxr, bool_t scroll)
{
	bool_t b_horz = 0;
	bool_t b_vert = 0;
...
void widget_rect_to_pt(widget_t wt, xrect_t* pxr)
{
	canvas_t canv;
	canvbox_t cb;
...
void widget_point_to_pt(widget_t wt, xpoint_t* ppt)
{
	canvas_t canv;
	canvbox_t cb;
...
void widget_point_to_mm(widget_t wt, xpoint_t* ppt)
{
	...
	point_pt_to_mm(canv, ppt);

	ft_offset_point(ppt, -cb.fx, -cb.fy);
}

void widget_size_to_pt(widget_t wt, xsize_t* pxs)
{
	canvas_t canv;
...
bool_t widget_point_corner(widget_t wt, const xpoint_t* ppt)
{
	xrect_t rt;
	int corn = 10;
...
bool_t widget_hand_scroll(widget_t wt, bool_t bHorz, int nLine)
{
	widget_exten_t* pwt = GETEXTENSTRUCT(wt);
	int nCur, nMax;
...
void widget_splitor_on_mousemove(widget_t wt, dword_t dw, const xpoint_t* pxp)
{
	widget_exten_t* pwt = GETEXTENSTRUCT(wt);
...
void widget_splitor_on_lbuttondown(widget_t wt, const xpoint_t* pxp)
{
	widget_exten_t* pwt = GETEXTENSTRUCT(wt);
...
void widget_splitor_on_lbuttonup(widget_t wt, const xpoint_t* pxp)
{
	widget_exten_t* pwt = GETEXTENSTRUCT(wt);
...
void widget_splitor_on_size(widget_t wt, int code, const xsize_t* pxs)
{
	widget_exten_t* pwt = GETEXTENSTRUCT(wt);
	xrect_t xr;
...
void widget_splitor_on_paint(widget_t wt, visual_t rdc, const xrect_t* prt)
{
	widget_exten_t* pwt = GETEXTENSTRUCT(wt);
...
int widget_splitor_sub_mousemove(widget_t wt, dword_t dw, const xpoint_t* pxp, uid_t sid, vword_t delta)
{
	widget_exten_t* pwt = GETEXTENSTRUCT(wt);
...
int widget_splitor_sub_lbuttondown(widget_t wt, const xpoint_t* pxp, uid_t sid, vword_t delta)
{
	widget_exten_t* pwt = GETEXTENSTRUCT(wt);
...
int widget_splitor_sub_lbuttonup(widget_t wt, const xpoint_t* pxp, uid_t sid, vword_t delta)
{
	widget_exten_t* pwt = GETEXTENSTRUCT(wt);
...
int widget_splitor_sub_size(widget_t wt, int code, const xsize_t* pxs, uid_t sid, vword_t delta)
{
	widget_exten_t* pwt = GETEXTENSTRUCT(wt);
	xrect_t xr;
...
int widget_splitor_sub_paint(widget_t wt, visual_t rdc, const xrect_t* prt, uid_t sid, vword_t delta)
{
	widget_exten_t* pwt = GETEXTENSTRUCT(wt);
...
void widget_docker_on_mousemove(widget_t wt, dword_t dw, const xpoint_t* pxp)
{
	widget_exten_t* pwt = GETEXTENSTRUCT(wt);
...
void widget_docker_on_lbuttondown(widget_t wt, const xpoint_t* pxp)
{
	widget_exten_t* pwt = GETEXTENSTRUCT(wt);
...
void widget_docker_on_lbuttonup(widget_t wt, const xpoint_t* pxp)
{
	widget_exten_t* pwt = GETEXTENSTRUCT(wt);
...
void widget_docker_on_paint(widget_t wt, visual_t rdc, const xrect_t* prt)
{
	widget_exten_t* pwt = GETEXTENSTRUCT(wt);
...
int widget_docker_sub_mousemove(widget_t wt, dword_t dw, const xpoint_t* pxp, uid_t sid, vword_t delta)
{
	widget_exten_t* pwt = GETEXTENSTRUCT(wt);
...
int widget_docker_sub_lbuttondown(widget_t wt, const xpoint_t* pxp, uid_t sid, vword_t delta)
{
	widget_exten_t* pwt = GETEXTENSTRUCT(wt);
...
int widget_docker_sub_lbuttonup(widget_t wt, const xpoint_t* pxp, uid_t sid, vword_t delta)
{
	widget_exten_t* pwt = GETEXTENSTRUCT(wt);
...
int widget_docker_sub_paint(widget_t wt, visual_t rdc, const xrect_t* prt, uid_t sid, vword_t delta)
{
	widget_exten_t* pwt = GETEXTENSTRUCT(wt);
