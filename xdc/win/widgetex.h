...
*/
EXP_API canvas_t widget_get_canvas(widget_t wt);
...
@RETURN void: none.
*/
EXP_API void	widget_attach_splitor(widget_t wt, link_t_ptr split);
...
*/
EXP_API link_t_ptr	widget_get_splitor(widget_t wt);
...
@RETURN link_t_ptr: return the splitor link component if exists, otherwise return NULL.
*/
EXP_API link_t_ptr	widget_detach_splitor(widget_t wt);
...
@RETURN void: none.
*/
EXP_API void	widget_layout_splitor(widget_t wt);
...
*/
EXP_API bool_t	widget_dock(widget_t wt, dword_t style, int cx, int cy);
...
@RETURN bool_t: return nonzero if added, return zero if exists.
*/
EXP_API void	widget_undock(widget_t wt, dword_t style);
...
@RETURN void: none.
*/
EXP_API void	widget_get_dock_rect(widget_t wt, dword_t style, xrect_t* pxr);
...
@RETURN void: none.
*/
EXP_API void	widget_attach_menu(widget_t wt, link_t_ptr menu);
...
*/
EXP_API link_t_ptr	widget_get_menu(widget_t wt);
...
@RETURN link_t_ptr: return the menu link component if exists, otherwise return NULL.
*/
EXP_API link_t_ptr	widget_detach_menu(widget_t wt);
...
@RETURN void: none.
*/
EXP_API void	widget_menu_item_rect(widget_t wt, int iid, xrect_t* pxr);
...
@RETURN void: none.
*/
EXP_API void	widget_get_view_rect(widget_t wt, viewbox_t* pbox);


EXP_API void widget_get_view_size(widget_t wt, xsize_t* pxs);
...
@RETURN void: none.
*/
EXP_API void	widget_client_to_viewbox(widget_t wt, xpoint_t* ppt);
...
@RETURN void: none.
*/
EXP_API void	widget_viewbox_to_client(widget_t wt, xpoint_t* pst);
...
@RETURN void: none.
*/
EXP_API void	widget_get_canv_rect(widget_t wt, canvbox_t* pbox);
...
@RETURN void: none.
*/
EXP_API void	widget_get_canv_size(widget_t wt, xsize_t* pxs);
...
@RETURN void: none.
*/
EXP_API	void	widget_reset_scroll(widget_t wt, bool_t horz);
...
@RETURN void: none.
*/
EXP_API void	widget_reset_paging(widget_t wt, int ww, int wh, int vw, int vh, int lw, int lh);
...
@RETURN void: none.
*/
EXP_API void	widget_ensure_visible(widget_t wt, const xrect_t* pxr, bool_t scroll);
...
EXP_API void widget_splitor_on_lbuttondown(widget_t widget, const xpoint_t* pxp);

EXP_API void widget_splitor_on_lbuttonup(widget_t widget, const xpoint_t* pxp);

EXP_API void widget_splitor_on_size(widget_t widget, int code, const xsize_t* pxs);

EXP_API void widget_splitor_on_paint(widget_t widget, visual_t rdc, const xrect_t* prt);

EXP_API int widget_splitor_sub_mousemove(widget_t widget, dword_t dw, const xpoint_t* pxp, uid_t sid, vword_t delta);

EXP_API int widget_splitor_sub_lbuttondown(widget_t widget, const xpoint_t* pxp, uid_t sid, vword_t delta);

EXP_API int widget_splitor_sub_lbuttonup(widget_t widget, const xpoint_t* pxp, uid_t sid, vword_t delta);

EXP_API int widget_splitor_sub_size(widget_t widget, int code, const xsize_t* pxs, uid_t sid, vword_t delta);

EXP_API int widget_splitor_sub_paint(widget_t widget, visual_t rdc, const xrect_t* prt, uid_t sid, vword_t delta);

/******************************widget docker implement*****************************************************/

EXP_API void widget_docker_on_mousemove(widget_t widget, dword_t dw, const xpoint_t* pxp);

EXP_API void widget_docker_on_lbuttondown(widget_t widget, const xpoint_t* pxp);

EXP_API void widget_docker_on_lbuttonup(widget_t widget, const xpoint_t* pxp);

EXP_API void widget_docker_on_paint(widget_t widget, visual_t rdc, const xrect_t* prt);

EXP_API int widget_docker_sub_mousemove(widget_t widget, dword_t dw, const xpoint_t* pxp, uid_t sid, vword_t delta);

EXP_API int widget_docker_sub_lbuttondown(widget_t widget, const xpoint_t* pxp, uid_t sid, vword_t delta);

EXP_API int widget_docker_sub_lbuttonup(widget_t widget, const xpoint_t* pxp, uid_t sid, vword_t delta);

EXP_API int widget_docker_sub_paint(widget_t widget, visual_t rdc, const xrect_t* prt, uid_t sid, vword_t delta);
