...
static void _WidgetDrawEdge(widget_t wt, visual_t rdc)
{
	border_t bd = { 0 };
	dword_t ws;
	xbrush_t xb;
	...
	(*ifv.pf_exclude_rect)((visual_t)ifv.ctx, &rtScr);
...
static void _WidgetDrawHScroll(widget_t wt, visual_t rdc)
{
	border_t bd = { 0 };
	xrect_t rtWnd, rtScr;
	scroll_t sl = { 0 };
	...
	calc_widget_border(widget_get_style(wt), &bd);
...
static void _WidgetDrawVScroll(widget_t wt, visual_t rdc)
{
	border_t bd = { 0 };
	xrect_t rtWnd, rtScr;
	scroll_t sl = { 0 };
...
static void _WidgetDrawTitleBar(widget_t wt, visual_t rdc)
{
...
static void _WidgetDrawMenuBar(widget_t wt, visual_t rdc)
{
...
void widgetnc_on_paint(widget_t wt, visual_t dc)
{
	border_t bd = { 0 };
...
void widgetnc_on_calcsize(widget_t wt, border_t* pbd)
{
	calc_widget_border(widget_get_style(wt), pbd);
}

int widgetnc_on_hittest(widget_t wt, const xpoint_t* pxp)
{
	int edge, title, vscr, hscr, menu;
	border_t bd = { 0 };
	dword_t ws;
...
int widgetnc_on_calcscroll(widget_t wt, bool_t horz, const xpoint_t* pxp)
{
...
void widget_draw_scroll(widget_t wt, bool_t horz)
{
	visual_t dc;
