...
{
	tchar_t fname[FNT_LEN + 1];
	tchar_t fweight[NUM_LEN + 1];
	tchar_t fstyle[INT_LEN + 1];
	tchar_t fsize[INT_LEN + 1];
	int n;

	xsncpy(fname, pxf->family, FNT_LEN);
