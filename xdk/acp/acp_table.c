...
int table_unicode_seek_gb2312(unsigned short ucs, unsigned char* mbs)
{
	int min = 0;
	int max = CODE_SIZE - 1;
	int mid;
...
bool_t save_gb2312_table(const tchar_t* fname)
{
	xhand_t fh;
	byte_t pch[3] = { 0 };
	byte_t uch[3] = { 0 };
	...
	{
		if (code_gb2312_unicode[i][0] < MIN_CHS_GB2312 || code_gb2312_unicode[i][0] > MAX_CHS_GB2312)
		{
			continue;
		}

		pch[0] = GETHBYTE(code_gb2312_unicode[i][0]);
		pch[1] = GETLBYTE(code_gb2312_unicode[i][0]);

		uch[0] = GETHBYTE(code_gb2312_unicode[i][1]);
		uch[1] = GETLBYTE(code_gb2312_unicode[i][1]);

		hlp[0] = (unsigned char)code_gb2312_unicode[i][2];

		xsprintf(str, _T("0x%02X%02X,0x%02X%02X,%c\n"), pch[0], pch[1], uch[0], uch[1], ((hlp[0])? hlp[0] : 0x20));
...
bool_t save_unicode_table(const tchar_t* fname)
{
	xhand_t fh;
	byte_t pch[3] = { 0 };
	byte_t uch[3] = { 0 };
	...
	for (i = 0; i < CODE_SIZE; i++)
	{
		if (code_unicode_gb2312[i][0] < MIN_CHS_UNICODE || code_unicode_gb2312[i][0] > MAX_CHS_UNICODE)
		{
			continue;
		}

		pch[0] = GETHBYTE(code_unicode_gb2312[i][0]);
		pch[1] = GETLBYTE(code_unicode_gb2312[i][0]);

		uch[0] = GETHBYTE(code_unicode_gb2312[i][1]);
		uch[1] = GETLBYTE(code_unicode_gb2312[i][1]);

		hlp[0] = (unsigned char)code_unicode_gb2312[i][2];
