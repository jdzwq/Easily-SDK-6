...
{
	dword_t len;         /*!<  The size of \p P in Bytes. */
...
extern "C" {
	...
	*/
	EXP_API void dhm_init(dhm_context *ctx);
	...
	* \return         An \c ERR_DHM_XXX error code on failure.
	*/
	EXP_API int dhm_make_params(dhm_context *ctx, int x_size,
	...
	* \return         An \c ERR_DHM_XXX error code on failure.
	*/
	EXP_API int dhm_set_group(dhm_context *ctx,
		const mpi *P,
		const mpi *G);
	...
	* \return         An \c ERR_DHM_XXX error code on failure.
	*/
	EXP_API int dhm_make_public(dhm_context *ctx, int x_size,
		byte_t *output, dword_t olen,
		int(*f_rng)(void *, byte_t *, dword_t),
		void *p_rng);
	...
	*                    code on failure.
	*/
	EXP_API int dhm_parse_dhm(dhm_context *dhm, const byte_t *dhmin,
		dword_t dhminlen);
	...
	*/
	EXP_API int dhm_self_test(int verbose);
