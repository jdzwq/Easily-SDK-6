...
typedef struct _gcm_context
{
	...
	lword_t HL[16];                      /*!< Precalculated HTable low. */
	lword_t HH[16];                      /*!< Precalculated HTable high. */
	lword_t len;                         /*!< The total length of the encrypted data. */
	lword_t add_len;                     /*!< The total length of the additional data. */
	byte_t base_ectr[16];          /*!< The first ECTR for tag. */
	byte_t y[16];                  /*!< The Y working value. */
	byte_t buf[16];                /*!< The buf working value. */
