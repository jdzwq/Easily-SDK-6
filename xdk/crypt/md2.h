...
typedef struct md2_context
{
	...
	dword_t left;                /*!< amount of data in buffer   */
 ...
 *
 */
EXP_API void md2_init(md2_context *ctx);
 ...
 *
 */
EXP_API void md2_free(md2_context *ctx);
 ...
 *
 */
EXP_API void md2_clone(md2_context *dst,
 ...
 *
 */
EXP_API int md2_starts(md2_context *ctx);
 ...
 *
 */
EXP_API int md2_update(md2_context *ctx,
                            const byte_t *input,
                            dword_t ilen );
 ...
 *
 */
EXP_API int md2_finish(md2_context *ctx,
                            byte_t output[16] );
 ...
 *
 */
EXP_API int internal_md2_process(md2_context *ctx);
 ...
 *
 */
EXP_API int md2(const byte_t *input,
                     dword_t ilen,
                     byte_t output[16] );
 ...
 *                  failure.
 */
EXP_API int md2_hmac_starts(md2_context *ctx, const byte_t *key,
                    dword_t keylen );
 ...
 *                  failure.
 */
EXP_API int md2_hmac_update(md2_context *ctx, const byte_t *input,
                    dword_t ilen );
 ...
 *                  failure.
 */
EXP_API int md2_hmac_finish(md2_context *ctx, byte_t output[16]);
 ...
 *                  failure.
 */
EXP_API int md2_hmac_reset(md2_context *ctx);
 ...
 *                 failure.
 */
EXP_API int md2_hmac(const byte_t *key, dword_t keylen,
 ...
 *
 */
EXP_API int md2_self_test( int verbose );
