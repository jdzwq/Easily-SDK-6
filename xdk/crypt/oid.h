 ...
 */
EXP_API int oid_get_numeric_string(char *buf, dword_t size, const asn1_buf *oid);
 ...
 */
EXP_API int oid_get_x509_ext_type(const asn1_buf *oid, int *ext_type);
 ...
 * \return         0 if successful, or ERR_OID_NOT_FOUND
 */
EXP_API int oid_get_attr_short_name(const asn1_buf *oid, const char **short_name);
 ...
 * \return         0 if successful, or ERR_OID_NOT_FOUND
 */
EXP_API int oid_get_pk_alg(const asn1_buf *oid, pk_type_t *pk_alg);
 ...
 * \return         0 if successful, or ERR_OID_NOT_FOUND
 */
EXP_API int oid_get_oid_by_pk_alg(pk_type_t pk_alg,
                           const char **oid, dword_t *olen );
 ...
 * \return         0 if successful, or ERR_OID_NOT_FOUND
 */
EXP_API int oid_get_ec_grp(const asn1_buf *oid, ecp_group_id *grp_id);
 ...
 * \return         0 if successful, or ERR_OID_NOT_FOUND
 */
EXP_API int oid_get_oid_by_ec_grp(ecp_group_id grp_id,
                           const char **oid, dword_t *olen );
 ...
 * \return         0 if successful, or ERR_OID_NOT_FOUND
 */
EXP_API int oid_get_sig_alg(const asn1_buf *oid,
 ...
 * \return         0 if successful, or ERR_OID_NOT_FOUND
 */
EXP_API int oid_get_sig_alg_desc(const asn1_buf *oid, const char **desc);
 ...
 * \return         0 if successful, or ERR_OID_NOT_FOUND
 */
EXP_API int oid_get_oid_by_sig_alg(pk_type_t pk_alg, md_type_t md_alg,
                            const char **oid, dword_t *olen );
 ...
 * \return         0 if successful, or ERR_OID_NOT_FOUND
 */
EXP_API int oid_get_md_alg(const asn1_buf *oid, md_type_t *md_alg);
 ...
 * \return         0 if successful, or ERR_OID_NOT_FOUND
 */
EXP_API int oid_get_md_hmac(const asn1_buf *oid, md_type_t *md_hmac);
 ...
 * \return         0 if successful, or ERR_OID_NOT_FOUND
 */
EXP_API int oid_get_extended_key_usage(const asn1_buf *oid, const char **desc);
 ...
 * \return         0 if successful, or ERR_OID_NOT_FOUND
 */
EXP_API int oid_get_oid_by_md(md_type_t md_alg, const char **oid, dword_t *olen);
 ...
 * \return         0 if successful, or ERR_OID_NOT_FOUND
 */
EXP_API int oid_get_cipher_alg(const asn1_buf *oid, cipher_type_t *cipher_alg);
 ...
 * \return         0 if successful, or ERR_OID_NOT_FOUND
 */
EXP_API int oid_get_pkcs12_pbe_alg(const asn1_buf *oid, md_type_t *md_alg, cipher_type_t *cipher_alg);
