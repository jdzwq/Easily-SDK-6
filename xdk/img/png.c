...
dword_t xpng_decompress(const byte_t* png_buf, dword_t png_len, byte_t* bmp_buf, dword_t bmp_size)
{
	...
	bitmap_file_head_t bf = { 0 };
	bitmap_info_head_t bi = { 0 };
...
#  endif
	...
	dTotal += xbmp_set_head(&bf,(bmp_buf + dTotal), (bmp_size - dTotal));
	dTotal += xbmp_set_info(&bi, (bmp_buf + dTotal), (bmp_size - dTotal));
	dTotal += xbmp_fill_quad(bi.clrbits, bi.clrused, (bmp_buf + dTotal), (bmp_size - dTotal));
...
dword_t xpng_compress(const byte_t* bmp_buf, dword_t bmp_len, byte_t* png_buf, dword_t png_size)
{
	...
	dTotal += xbmp_get_head(&bf, (bmp_buf + dTotal), (bmp_len - dTotal));
	dTotal += xbmp_get_info(&bi, (bmp_buf + dTotal), (bmp_len - dTotal));
