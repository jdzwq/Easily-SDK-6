...
/*
@FUNCTION process_waitrun: pause process executing till the child child process can input.
@INPUT res_proc_t ph: the child process handle.
@RETURN void: none.
*/
EXP_API void process_wait_run(res_proc_t ph);

/*
@FUNCTION process_wait_exit: pause process executing till the child process exit.
@INPUT res_proc_t ph: the child process handle.
@RETURN void: none.
*/
EXP_API void process_wait_exit(res_proc_t ph);
