/***********************************************************************
	...
	@module	impplat.c | implement file
...
{
	pif->pf_utf_to_ucs = c_utf_to_ucs;
	pif->pf_ucs_to_utf = c_ucs_to_utf;
	pif->pf_gbk_to_ucs = c_gbk_to_ucs;
	pif->pf_ucs_to_gbk = c_ucs_to_gbk;
}
#endif
...
void xdk_impl_process(if_process_t* pif)
{
	...
	pif->pf_process_wait_run = _process_wait_run;
	pif->pf_process_wait_exit = _process_wait_exit;
