...
typedef struct _tls10_ciphers_set{
	int cipher;
	int type;
	int bulk;
	int key_size;
...
static tls10_ciphers_set client_ciphers[] = {
...
static tls10_ciphers_set server_ciphers[] = {
	{ XSSL_DHE_RSA_WITH_3DES_EDE_CBC_SHA, CIPHER_BLOCK, BULK_3DES, 24, 20, 8 },
	{ XSSL_RSA_WITH_3DES_EDE_CBC_SHA, CIPHER_BLOCK, BULK_3DES, 24, 20, 8 },
	{ XSSL_RSA_WITH_RC4_128_SHA, CIPHER_STREAM, BULK_RC4, 16, 20, 0 },
	{ XSSL_RSA_WITH_RC4_128_MD5, CIPHER_STREAM, BULK_RC4, 16, 16, 0 },
...
}tls10_handshake_states;

typedef struct _tls10_cipher_context{
	//SecurityParameters
...
static bool_t _ssl_choose_cipher(tls10_cipher_context *pcip, int ciph)
{
	int i, n;
	tls10_ciphers_set* pcs;

	if (pcip->endpoint == SSL_TYPE_CLIENT)
	{
		n = sizeof(client_ciphers) / sizeof(tls10_ciphers_set);
		pcs = client_ciphers;
	}
	else
	{
		n = sizeof(server_ciphers) / sizeof(tls10_ciphers_set);
		pcs = server_ciphers;
	}
...
static void _ssl_derive_keys(tls10_cipher_context *pcip, byte_t* premaster, int prelen)
{
...
static int _ssl_encrypt_snd_msg(ssl_context *pssl)
{
	...
	tls10_cipher_context* pcip = (tls10_cipher_context*)pses->cipher_context;
...
static int _ssl_read_rcv_msg(ssl_context *pssl)
{
	...
	*/
	...
	if (pses->major_ver)
	{
		...
		if (prec->rcv_hdr[2] > SSL_MINOR_VERSION_1)
		{
			_ssl_set_error(pses->alert_code = SSL_ALERT_UNEXPECTED_MESSAGE);
...
{
	tls10_cipher_context* pcip = (pses) ? (tls10_cipher_context*)pses->cipher_context : NULL;
...
{
	ssl_session_context* pses = (ssl_session_context*)pssl->session_context;
	tls10_cipher_context* pcip;

	pcip = (tls10_cipher_context*)xmem_alloc(sizeof(tls10_cipher_context));
	//initialize tools
	...
	if (pssl->type == SSL_TYPE_SERVER)
	{
		...
		pssl->srv_minor_ver = SSL_MINOR_VERSION_1;
	}
}
...
static tls10_handshake_states _ssl_write_client_hello(ssl_context *pssl)
{
	ssl_session_context* pses = (ssl_session_context*)pssl->session_context;
	tls10_cipher_context* pcip = (tls10_cipher_context*)pses->cipher_context;
	ssl_security_context* psec = (ssl_security_context*)pssl->security_context;
...
static tls10_handshake_states _ssl_parse_server_hello(ssl_context *pssl)
{
	ssl_session_context* pses = (ssl_session_context*)pssl->session_context;
	tls10_cipher_context* pcip = (tls10_cipher_context*)pses->cipher_context;
	ssl_security_context* psec = (ssl_security_context*)pssl->security_context;
	...
	*/
	...
	if (prec->rcv_msg[4] != SSL_MAJOR_VERSION_3 || prec->rcv_msg[5] > SSL_MINOR_VERSION_1)
	{
		_ssl_set_error(pses->alert_code = SSL_ALERT_UNEXPECTED_MESSAGE);
...
static tls10_handshake_states _ssl_parse_server_certificate(ssl_context *pssl)
{
	ssl_session_context* pses = (ssl_session_context*)pssl->session_context;
	tls10_cipher_context* pcip = (tls10_cipher_context*)pses->cipher_context;
	ssl_security_context* psec = (ssl_security_context*)pssl->security_context;
...
static tls10_handshake_states _ssl_write_client_certificate(ssl_context *pssl)
{
	ssl_session_context* pses = (ssl_session_context*)pssl->session_context;
	tls10_cipher_context* pcip = (tls10_cipher_context*)pses->cipher_context;
	ssl_security_context* psec = (ssl_security_context*)pssl->security_context;
...
static tls10_handshake_states _ssl_write_client_change_cipher_spec(ssl_context *pssl)
{
	ssl_session_context* pses = (ssl_session_context*)pssl->session_context;
	tls10_cipher_context* pcip = (tls10_cipher_context*)pses->cipher_context;
	ssl_security_context* psec = (ssl_security_context*)pssl->security_context;
...
static tls10_handshake_states _ssl_write_client_finished(ssl_context *pssl)
{
	ssl_session_context* pses = (ssl_session_context*)pssl->session_context;
	tls10_cipher_context* pcip = (tls10_cipher_context*)pses->cipher_context;
	ssl_security_context* psec = (ssl_security_context*)pssl->security_context;
...
static tls10_handshake_states _ssl_parse_server_change_cipher_spec(ssl_context *pssl)
{
	ssl_session_context* pses = (ssl_session_context*)pssl->session_context;
	tls10_cipher_context* pcip = (tls10_cipher_context*)pses->cipher_context;
	ssl_security_context* psec = (ssl_security_context*)pssl->security_context;
...
static tls10_handshake_states _ssl_parse_server_finished(ssl_context *pssl)
{
	ssl_session_context* pses = (ssl_session_context*)pssl->session_context;
	tls10_cipher_context* pcip = (tls10_cipher_context*)pses->cipher_context;
	ssl_security_context* psec = (ssl_security_context*)pssl->security_context;
...
bool_t tls10_handshake_client(ssl_context *pssl)
{
	ssl_session_context* pses = (ssl_session_context*)pssl->session_context;
	tls10_handshake_states state = SSL_HELLO_REQUEST;
...
static tls10_handshake_states _ssl_parse_client_hello(ssl_context *pssl)
{
	ssl_session_context* pses = (ssl_session_context*)pssl->session_context;
	tls10_cipher_context* pcip = (tls10_cipher_context*)pses->cipher_context;
	ssl_security_context* psec = (ssl_security_context*)pssl->security_context;
...
static tls10_handshake_states _ssl_write_server_hello(ssl_context *pssl)
{
	ssl_session_context* pses = (ssl_session_context*)pssl->session_context;
	tls10_cipher_context* pcip = (tls10_cipher_context*)pses->cipher_context;
	ssl_security_context* psec = (ssl_security_context*)pssl->security_context;
...
static tls10_handshake_states _ssl_write_server_certificate(ssl_context *pssl)
{
	ssl_session_context* pses = (ssl_session_context*)pssl->session_context;
	tls10_cipher_context* pcip = (tls10_cipher_context*)pses->cipher_context;
	ssl_security_context* psec = (ssl_security_context*)pssl->security_context;
...
static tls10_handshake_states _ssl_write_server_key_exchange(ssl_context *pssl)
{
	ssl_session_context* pses = (ssl_session_context*)pssl->session_context;
	tls10_cipher_context* pcip = (tls10_cipher_context*)pses->cipher_context;
	ssl_security_context* psec = (ssl_security_context*)pssl->security_context;
...
static tls10_handshake_states _ssl_write_server_certificate_request(ssl_context *pssl)
{
	ssl_session_context* pses = (ssl_session_context*)pssl->session_context;
	tls10_cipher_context* pcip = (tls10_cipher_context*)pses->cipher_context;
	ssl_security_context* psec = (ssl_security_context*)pssl->security_context;
...
static tls10_handshake_states _ssl_write_server_hello_done(ssl_context *pssl)
{
	ssl_session_context* pses = (ssl_session_context*)pssl->session_context;
	tls10_cipher_context* pcip = (tls10_cipher_context*)pses->cipher_context;
	ssl_security_context* psec = (ssl_security_context*)pssl->security_context;
...
static tls10_handshake_states _ssl_parse_client_certificate(ssl_context *pssl)
{
	ssl_session_context* pses = (ssl_session_context*)pssl->session_context;
	tls10_cipher_context* pcip = (tls10_cipher_context*)pses->cipher_context;
	ssl_security_context* psec = (ssl_security_context*)pssl->security_context;
...
static tls10_handshake_states _ssl_parse_client_key_exchange(ssl_context *pssl)
{
	ssl_session_context* pses = (ssl_session_context*)pssl->session_context;
	tls10_cipher_context* pcip = (tls10_cipher_context*)pses->cipher_context;
	ssl_security_context* psec = (ssl_security_context*)pssl->security_context;
...
static tls10_handshake_states _ssl_parse_client_certificate_verify(ssl_context *pssl)
{
	ssl_session_context* pses = (ssl_session_context*)pssl->session_context;
	tls10_cipher_context* pcip = (tls10_cipher_context*)pses->cipher_context;
	ssl_security_context* psec = (ssl_security_context*)pssl->security_context;
	...
	*/
	...
	if (C_OK != rsa_pkcs1_verify(psec->peer_crt->rsa, pssl->f_rng, pssl->r_rng, RSA_PUBLIC, RSA_HASH_NONE, 36, hash, prec->rcv_msg + msglen))
	{
		_ssl_set_error(pses->alert_code = SSL_ALERT_ILLEGAL_PARAMETER);
...
static tls10_handshake_states _ssl_parse_client_change_cipher_spec(ssl_context *pssl)
{
	ssl_session_context* pses = (ssl_session_context*)pssl->session_context;
	tls10_cipher_context* pcip = (tls10_cipher_context*)pses->cipher_context;
	ssl_security_context* psec = (ssl_security_context*)pssl->security_context;
...
static tls10_handshake_states _ssl_parse_client_finished(ssl_context *pssl)
{
	ssl_session_context* pses = (ssl_session_context*)pssl->session_context;
	tls10_cipher_context* pcip = (tls10_cipher_context*)pses->cipher_context;
	ssl_security_context* psec = (ssl_security_context*)pssl->security_context;
...
static tls10_handshake_states _ssl_write_server_change_cipher_spec(ssl_context *pssl)
{
	ssl_session_context* pses = (ssl_session_context*)pssl->session_context;
	tls10_cipher_context* pcip = (tls10_cipher_context*)pses->cipher_context;
	ssl_security_context* psec = (ssl_security_context*)pssl->security_context;
...
static tls10_handshake_states _ssl_write_server_finished(ssl_context *pssl)
{
	ssl_session_context* pses = (ssl_session_context*)pssl->session_context;
	tls10_cipher_context* pcip = (tls10_cipher_context*)pses->cipher_context;
	ssl_security_context* psec = (ssl_security_context*)pssl->security_context;
...
bool_t tls10_handshake_server(ssl_context *pssl)
{
	ssl_session_context* pses = (ssl_session_context*)pssl->session_context;
	tls10_handshake_states state = SSL_HELLO_REQUEST;
