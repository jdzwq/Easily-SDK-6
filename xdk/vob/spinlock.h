...
#define SHARE_SPINLOCK		_T("share_spinlock")
...
*/
EXP_API spinlock_t alloc_spinlock(dword_t nums_permap);
...
*/
EXP_API bool_t enter_spinlock(spinlock_t pt, dword_t map_ind, dword_t map_pos);
...
@RETURN bool_t: if succeeded return none zero.
*/
EXP_API void leave_spinlock(spinlock_t pt, dword_t map_ind, dword_t map_pos);
