...
dword_t save_bytes_to_file(const secu_desc_t* psd, const tchar_t* fname, const byte_t* buf, dword_t len)
{
	file_t xf = NULL;
...
dword_t load_bytes_from_file(const secu_desc_t* psd, const tchar_t* fname, byte_t* buf, dword_t max)
{
