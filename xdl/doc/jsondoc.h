...
/*
@PROPER numeric: boolean.
@SET set_json_item_numeric: make the josn item is numeric.
*/
#define set_json_item_number(ilk,b)						set_dom_node_mask_check(ilk,MSK_NUMBER,b)
/*
@PROPER numeric: boolean.
@SET get_json_item_numeric: test the josn item is numeric.
*/
#define get_json_item_number(ilk)						get_dom_node_mask_check(ilk,MSK_NUMBER)
/*
@PROPER null: boolean.
@SET set_json_item_null: make the josn item is null.
*/
#define set_json_item_null(ilk,b)						set_dom_node_mask_check(ilk,MSK_NULL,b)
/*
@PROPER null: boolean.
@SET get_json_item_null: test the josn item is null.
*/
#define get_json_item_null(ilk)						get_dom_node_mask_check(ilk,MSK_NULL)
