...
@RETURN void: none.
*/
EXP_API void write_arc_to_svg_node(link_t_ptr glk, const xpen_t* pxp, const xpoint_t* ppt1, const xpoint_t* ppt2, const xsize_t* pxs, bool_t sflag, bool_t lflag);
...
@RETURN void: none
*/
EXP_API void read_arc_from_svg_node(link_t_ptr glk, xpen_t* pxp, xpoint_t* ppt1, xpoint_t* ppt2, xsize_t* pxs, bool_t* psflag, bool_t* plflag);
...
@RETURN void: none
*/
EXP_API void read_sector_from_svg_node(link_t_ptr glk, xpen_t* pxp, xbrush_t* pxb, xpoint_t* ppt, xspan_t* prs, xspan_t* prl, double* pfang, double* psang);
