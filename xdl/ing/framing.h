...
@RETURN void: none.
*/
EXP_API void	draw_progress(const drawing_interface* pci, const xcolor_t* pxc, const xrect_t* prt, int steps);
...
@RETURN void: none.
*/
EXP_API void	draw_ruler(const drawing_interface* pci, const xcolor_t* pxc, const xrect_t* prt);
...
@RETURN void: none.
*/
EXP_API void	draw_corner(const drawing_interface* pci, const xcolor_t* pxc, const xrect_t* prt);
