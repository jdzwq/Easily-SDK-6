...
void svg_draw_arc_raw(visual_t view, const xpen_t* pxp, const xpoint_t* ppt1, const xpoint_t* ppt2, const xsize_t* pxs, bool_t sflag, bool_t lflag)
{
	...
	write_arc_to_svg_node(nlk, pxp, ppt1, ppt2, pxs, sflag, lflag);
}
...
void svg_draw_round_raw(visual_t view, const xpen_t* pxp, const xbrush_t* pxb, const xrect_t* pxr, const xsize_t* pxs)
{
	link_t_ptr g, nlk;
	int r;
	...
	write_round_to_svg_node(nlk, pxp, pxb, pxr, r, r);
}

void svg_draw_round(canvas_t canv, const xpen_t* pxp, const xbrush_t* pxb, const xrect_t* pxr, const xsize_t* pxs)
{
	visual_t view;
	xrect_t xr;
	xsize_t xs;
...
void svg_draw_pie_raw(visual_t view, const xpen_t* pxp, const xbrush_t* pxb, const xrect_t* prt, double fang, double sang)
{
	link_t_ptr g, nlk;
	...
	write_pie_to_svg_node(nlk, pxp, pxb, prt, fang, sang);
}

void svg_draw_pie(canvas_t canv, const xpen_t* pxp, const xbrush_t* pxb, const xrect_t* prt, double fang, double sang)
{
	visual_t view;
	xrect_t xr;
...
void svg_draw_sector_raw(visual_t view, const xpen_t* pxp, const xbrush_t* pxb, const xpoint_t* ppt, const xspan_t* prl, const xspan_t* prs, double fang, double sang)
{
	link_t_ptr g, nlk;
	...
	write_sector_to_svg_node(nlk, pxp, pxb, ppt, prl, prs, fang, sang);
}

void svg_draw_sector(canvas_t canv, const xpen_t* pxp, const xbrush_t* pxb, const xpoint_t* ppt, const xspan_t* prl, const xspan_t* prs, double fang, double sang)
{
	visual_t view;
	xpoint_t pt;
	xspan_t rl, rs;
...
void svg_draw_equilagon_raw(visual_t view, const xpen_t* pxp, const xbrush_t* pxb, const xpoint_t* ppt, const xspan_t* pxn, int n)
{
	xpoint_t* pa;
...
void svg_draw_equilagon(canvas_t canv, const xpen_t* pxp, const xbrush_t* pxb, const xpoint_t* ppt, const xspan_t* pxn, int n)
{
	visual_t view;
...
void svg_multi_line_raw(visual_t view, const xface_t* pxa, const xpen_t* pxp, const xrect_t* pxr)
{
	link_t_ptr g, nlk;
...
void svg_multi_line(canvas_t canv, const xface_t* pxa, const xpen_t* pxp, const xrect_t* pxr)
{
	visual_t view;
	xrect_t xr;
	...
	svg_multi_line_raw(view, pxa, pxp, &xr);
}

void svg_text_out_raw(visual_t view, const xpoint_t* ppt, const tchar_t* txt, int len)
{
	...
	svg_text_size_raw(view, txt, len, RECTSIZE(&xr));
	default_xface(&xa);

	write_text_to_svg_node(nlk, &(pview->xf), &xa, &xr, txt, len);
}

void svg_text_out(canvas_t canv, const xpoint_t* ppt, const tchar_t* txt, int len)
{
	xpoint_t pt = { 0 };
	visual_t view;
	...
	svg_text_out_raw(view, &pt, txt, len);
}

static void _draw_single_text_raw(visual_t view, const xface_t* pxa, const xrect_t* pxr, const tchar_t* txt, int len)
{
	svg_visual_t* pview = TypePtrFromHead(svg_visual_t, view);
	link_t_ptr g, nlk;
	...
	write_text_to_svg_node(nlk, &(pview->xf), pxa, pxr, txt, len);
}

static void _draw_multi_text_raw(visual_t view, const xface_t* pxa, const xrect_t* pxr, const tchar_t* txt, int len)
{
	svg_visual_t* pview = TypePtrFromHead(svg_visual_t, view);
	link_t_ptr g, nlk;
	...
	while (total < len)
	{
		...
		{
			nlk = insert_svg_node(g);
			write_text_to_svg_node(nlk, &(pview->xf), pxa, &xr, (txt + total - m), m);
...
void svg_draw_text(canvas_t canv, const xface_t* pxa, const xrect_t* pxr, const tchar_t* txt, int len)
{
	visual_t view;
	xrect_t xr;
...
void svg_text_rect(canvas_t canv, const xface_t* pxa, const tchar_t* txt, int len, xrect_t* pxr)
{
	...
	svg_text_rect_raw(view, pxa, txt, len, pxr);
...
void svg_text_size(canvas_t canv, const tchar_t* txt, int len, xsize_t* pxs)
{
	...
	svg_text_size_raw(view, txt, len, pxs);
