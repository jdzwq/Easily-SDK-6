...
@INPUT widget_t win: the clipboard to ownered widget.
...
*/
EXP_API bool_t	clipboard_put(widget_t win, int fmt, const byte_t* data, dword_t size);
...
*/
EXP_API dword_t clipboard_get(widget_t win, int fmt, byte_t* buf, dword_t max);
