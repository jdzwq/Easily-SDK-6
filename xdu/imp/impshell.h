...
@RETURN bool_t: if succeeds return nonzero, fails return zero.
*/
EXP_API bool_t shell_get_filename(widget_t owner, const tchar_t* defpath, const tchar_t* filter, const tchar_t* defext, bool_t saveit, tchar_t* pathbuf, int pathlen, tchar_t* filebuf, int filelen);
