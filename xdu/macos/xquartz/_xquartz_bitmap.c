/***********************************************************************
	...
	@module	xquartz_bitmap.c | xquartz implement file
...
bitmap_t xqCreateContextBitmap(visual_t rdc)
{
	...
	xquartz_bitmap_t* bmp;

	bmp = (xquartz_bitmap_t*)xmem_alloc_handle(sizeof(xquartz_bitmap_t));
...
{
    xquartz_bitmap_t* bmp = (xquartz_bitmap_t*)rb;
