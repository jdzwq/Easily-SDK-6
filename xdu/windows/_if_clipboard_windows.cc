...
{
#if defined(WINCE)
	return wceClipboardPut(wt, fmt, data, size);
#elif defined(WIN32)
	return winClipboardPut(wt, fmt, data, size);
#endif
}
...
{
#if defined(WINCE)
	return wceClipboardGet(wt, fmt, buf, max);
#elif defined(WIN32)
	return winClipboardGet(wt, fmt, buf, max);
#endif
}
