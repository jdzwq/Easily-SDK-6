/***********************************************************************
	...
	@module	if_bitmap_win32.c | windows implement file
...
void winDestroyBitmap(bitmap_t bmp)
{
...
void winGetBitmapSize(bitmap_t rb, int* pw, int* ph)
{
...
bitmap_t winCreateStorageBitmap(visual_t rdc, const tchar_t* filename)
{
	win32_context_t* ctx = (win32_context_t*)rdc;
	HDC hDC = (HDC)(ctx->context);
	win32_bitmap_t* pwb;
