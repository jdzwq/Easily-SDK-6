...
bool_t winShellGetFileName(widget_t wt, const tchar_t* defpath, const tchar_t* filter, const tchar_t* defext, bool_t saveit, tchar_t* pathbuf, int pathlen, tchar_t* filebuf, int filelen)
{
...
bool_t winShellGetPathName(widget_t wt, const tchar_t* defpath, bool_t createit, tchar_t* pathbuf, int pathlen)
{
	win32_widget_t* pws = (win32_widget_t*)wt;
	BROWSEINFO brw = { 0 };
