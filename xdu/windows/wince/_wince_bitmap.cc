/***********************************************************************
	...
	@module	if_bitmap_wince.c | windows implement file
...
void wceDestroyBitmap(bitmap_t bmp)
{
	wince_bitmap_t* pwb = (wince_bitmap_t*)bmp;
...
void wceGetBitmapSize(bitmap_t rb, int* pw, int* ph)
{
	wince_bitmap_t* pwb = (wince_bitmap_t*)rb;
...
bitmap_t wceCreateContextBitmap(visual_t rdc)
{
	...
	pwb = (wince_bitmap_t*)xmem_alloc(sizeof(wince_bitmap_t));
...
bitmap_t wceCreateStorageBitmap(visual_t rdc, const tchar_t* filename)
{
	wince_context_t* ctx = (wince_context_t*)rdc;
	HDC hDC = (HDC)(ctx->context);
	wince_bitmap_t* pwb;
