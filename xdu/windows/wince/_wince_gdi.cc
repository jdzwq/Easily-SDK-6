/***********************************************************************
	...
	@module	if_gdi_wince.c | windows implement file
...
void wceGdiDrawCurve(visual_t rdc, const xpen_t* pxp, const xpoint_t* ppt, int n)
{
	HDC hDC = (HDC)(rdc->context);
...
void wceGdiGradientRect(visual_t rdc, const xgradi_t* pxg, const xrect_t* prt)
{
	HDC hDC = (HDC)(rdc->context);
...
void wceGdiDrawRound(visual_t rdc,const xpen_t* pxp,const xbrush_t* pxb,const xrect_t* prt)
{
	HDC hDC = (HDC)(rdc->context);
	int r;
...
void wceGdiDrawPie(visual_t rdc, const xpen_t* pxp, const xbrush_t*pxb, const xpoint_t* ppt, int rx, int ry, double fang, double tang)
{
	NOP;
}

void wceGdiDrawArrow(visual_t rdc,const xpen_t* pxp,const xbrush_t* pxb,const xrect_t* prt,int alen,double arc)
{
	HDC hDC = (HDC)(rdc->context);
	double a1;
...
void wceGdiDrawText(visual_t rdc,const xfont_t* pxf,const xface_t* pxa,const xrect_t* prt,const tchar_t* txt,int len)
{
	HDC hDC = (HDC)(rdc->context);
...
void wceGdiTextOut(visual_t rdc, const xfont_t* pxf, const xpoint_t* ppt, const tchar_t* txt, int len)
{
	HDC hDC = (HDC)(rdc->context);
	HFONT hFont, orgFont;
	COLORREF clr, orgClr;
...
void wceGdiDrawImage(visual_t rdc,bitmap_t hBmp,const tchar_t* clr,const xrect_t* prt)
{
	HDC hDC = (HDC)(rdc->context);
...
void wceGdiDrawBitmap(visual_t rdc, bitmap_t hbmp, const xpoint_t* ppt)
{
	HDC hDC = (HDC)(rdc->context);
...
void wceGdiFillRegion(visual_t rdc, const xbrush_t* pxb, res_rgn_t rgn)
{
	HDC hDC = (HDC)(rdc->context);
	HBRUSH hBrush;
...
void wceGdiExclipRect(visual_t rdc, const xrect_t* pxr)
{
	HDC hDC = (HDC)(rdc->context);
...
void wceGdiTextMetric(visual_t rdc, const xfont_t* pxf, xsize_t* pxs)
{
	BOOL bRef = 0;
	HDC hDC;
