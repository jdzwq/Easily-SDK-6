...
LOC_API void	_widget_show_caret(widget_t wt, int x, int y, bool_t b);
...
LOC_API void	_widget_set_color_mode(widget_t wt, const clr_mod_t* pclr);
LOC_API void	_widget_get_color_mode(widget_t wt, clr_mod_t* pclr);
