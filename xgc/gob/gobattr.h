...
#define GDI_ATTR_STROKE_STYLE_DASH		_T("dash")
#define GDI_ATTR_STROKE_STYLE_DASHDASH	_T("dashdash")
#define GDI_ATTR_STROKE_STYLE_DASHDASHDASH	_T("dashdashdash")
#define GDI_ATTR_STROKE_STYLE_OPTIONS	_T("solid~Solid;dash~Dash;dashdash~DashDash;dashdashdash~DashDashDash;")
...
#define GDI_ATTR_FONT_STYLE_OPTIONS		_T("regular~Regular;italic~Italic;oblique~Oblique;")

#define GDI_ATTR_FONT_DECORATE_NORMAL		_T("normal")
#define GDI_ATTR_FONT_DECORATE_UNDERLINE	_T("underline")
#define GDI_ATTR_FONT_DECORATE_STRIKOUT		_T("strikout")
#define GDI_ATTR_FONT_DECORATE_OPTIONS		_T("normal~Normal;underline~Underline;strikout~Strikout;")
...
#define DEF_GDI_SYSTEM_LINE_HEIGHT		_T("1.0")
